...
<div class="page">
  <div class="pagewhite">
    ...
    <div class="pagemain">
      ...
      <div class="jobs" id="job2" style="display:block"> 
         
        
        <div class="job">
      	<div class="jobname"><b>资深C++研发工程师</b></div>
          <div class="clear"></div>
          <br />
          <p><strong>工作地点</strong>：成都、广州<br />
            <strong>工作内容</strong>：<br />
            云主机管理平台、分布式块存储、SDN等分布式计算技术研发；<br />
            云计算相关技术预研和产品路线规划；<br />
            技术问题支持及排查；<br /> 
            <strong>工作内容</strong>：开发环境：linux/gcc/C++<br />
            <strong>职位要求</strong>：<br />
           对多线程工作机制和原理有清晰认识，精通现代开发语言中的线程模型，能够熟练使用&lt;thread&gt;/&lt;mutex&gt;<br/>/&lt;condition_variable&gt;等标准库根据设计要求进行高性能服务开发，能够准确定位系统性能瓶颈并优化解决。；<br />
            熟悉网络通讯原理，对网络交换、路由、NAT等常见网络概念有清醒认识，能够熟练使用epoll等基础框架根据设计要求开发高性能网络通讯组件，能够进行网络通讯故障分析、排查，能够自行设计私有通讯协议或者根据RFC文档实现协议栈；<br />
           熟悉常用数据结构和设计模式，能够根据需要进行数据结构和流程设计，能够对现有问题进行定位和优化；<br />
            有电信、网络通讯、视频安防、网络存储或其他大型软件系统设计及核心模块开发经验，要求8年以上linux/c++开发经验；<br />
            思路清晰，逻辑严密，能够快速分析定位并解决各种复杂技术问题；<br />
            能够有效管理时间，主动积极沟通，合理制定工作计划，确保任务保质保量完成，有团队管理或者创业经验优先；<br />
            对技术创新和改进充满热情，勇于挑战未知领域并不断自我折腾，拥有geek精神的优先；<br />
            熟悉云计算技术，期望用自主研发的本土技术改变云计算甚至传统IT领域格局的优先；<br />
            <br />
          </p>
        </div>
