            ...
            <div class="box">
              <div class="title">致云账号注册</div>
               <form id="terminal_user_add_dlg_form" method="post"> 
			      ...
			      <input id="inputpassword2" autocomplete="off" name="confpassword" type="password" onpaste='return false' onfocus="inputfocus('password2');" onblur="inputblur('password2'),checkPasswordConf()" class="itext"  style="background:#eef0f1"/>
			      <div class="itip" style="height:20px">
