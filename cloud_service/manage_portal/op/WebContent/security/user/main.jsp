		...
		<table id="main_table" border="0" cellspacing="0" cellpadding="0" style="height:100%;">
			<tr>
				<td id="c1" class="navbar" style="width:200px; vertical-align:top;">
					...
					<ul>
						<li><a href="javascript:void(0);" id="base_info_link" class="navbarnavactive">基本信息</a></li>
						<li><a href="javascript:void(0);" id="my_cloud_host_link" >我的云主机</a></li>
						<li><a href="javascript:void(0);" id="my_cloud_disk_link" >我的云硬盘</a></li>
						<li><a href="javascript:void(0);" id="my_uploaded_file_link" >我的文件</a></li>
						<li><a href="javascript:void(0);" id="my_bill_link">我的对账单</a></li>
						<li><a href="javascript:void(0);" id="historical_order_link">历史订单</a></li>
						<li><a href="javascript:void(0);" id="change_password_link">修改密码</a></li>
		<!-- 				<li><a href="#" id="invite_code_link">我的邀请码</a></li> -->
						<li><a href="javascript:void(0);" id="suggestion">意见反馈</a></li>
						<li><a href="javascript:void(0);" id="recharge_record">充值记录</a></li>
						<li><a href="javascript:void(0);" id="recharge">充值</a></li>
						<li><a href="javascript:void(0);" id="invoice">发票管理</a></li>
						<li><a href="javascript:void(0);" id="oper_log">操作日志</a></li>
					</ul>
				</td>
				<td id="c2" class="control" style="width:-1px; vertical-align:top;">
					...
					<div id="c2_r1" class="controlheader" style="height:60px; position:relative; background:#fcfcfc; border-bottom:solid 1px #acc0b7;">
						...
						<div class="controlheaderbutton productbutton l">
							<a href="javascript:void(0);" style="width: 28px;">产品</a>
						</div>
						<div class="controlheaderbutton l">
