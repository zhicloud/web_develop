...
<div class="page">
  <div class="pagebox">
    <div class="header">
      <div class="headerbox">
        <div class="headerlogo l"><a href="javascript:void(0);"><img src="<%=request.getContextPath()%>/images/logo_green_light_145_29.gif" width="145" height="29" alt="云端在线" /></a></div>
        <div class="headerlogout r"><a href="javascript:void(0);" id="logout_link">注销</a></div>
    ...
    <div class="nav">
      <div class="navbox">
        ...
        <div class="navbutton l"><a href="javascript:void(0);">定制云主机</a></div>
        <div class="navsplitter l">&nbsp;</div>
        <div class="navbutton l"><a href="javascript:void(0);">相关下载</a></div>
        <div class="navcontrol r"><a href="javascript:void(0);"><span>我的云端</span></a></div>
      </div>
    </div>
    <div class="main">
    ...
    <div class="sitemap">
      <div class="sitemapbox">
        <div class="sitemapsocial">
          <div class="sitemaplogo l"><a href="javascript:void(0);"><img src="<%=request.getContextPath()%>/images/logo_green_dark_40_29.gif" width="40" height="29" alt="云端在线" /></a></div>
          <div class="sitemapweixin r"><a href="javascript:void(0);">微信扫二维码<br />
            关注云端在线</a></div>
          <div class="sitemapweibo r"><a href="javascript:void(0);">新浪<br />
            微博</a></div>
        </div>
        <ul>
        ...
        <ul>
          <li><a href="javascript:void(0);">定制云主机</a></li>
          <li><a href="javascript:void(0);">试用</a></li>
          <li><a href="javascript:void(0);">包月试用</a></li>
          <li><a href="javascript:void(0);">按量付费</a></li>
        </ul>
        <ul>
          <li><a href="javascript:void(0);">相关下载</a></li>
        </ul>
        <ul>
          <li><a href="javascript:void(0);">我的云端</a></li>
          <li><a href="javascript:void(0);">我的云主机</a></li>
          <li><a href="javascript:void(0);">财务中心</a></li>
          <li><a href="javascript:void(0);">用户中心</a></li>
        </ul>
        <ul>
          <li><a href="javascript:void(0);">账户注册</a></li>
          <li><a href="javascript:void(0);">账户登录</a></li>
        </ul>
        <ul>
