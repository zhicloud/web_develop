			...
			<td>
				...
				<div class="cloud_host_item_buttons_box" style="text-align:right;">
					...
					<%if("关机".equals(cloudHost.getSummarizedStatusText())) {%>
						<a href="javascript:void(0);" class="easyui-linkbutton launch" data-options="iconCls:'icon-tip'">启动</a>
						<a href="javascript:void(0);" class="easyui-linkbutton " data-options="iconCls:'icon-no'" disabled="false">关机</a>
						<a href="javascript:void(0);" class="easyui-linkbutton " data-options="iconCls:'icon-reload'" disabled="false">重启</a>
					<%}else if("运行".equals(cloudHost.getSummarizedStatusText())) {%>
						<a href="javascript:void(0);" class="easyui-linkbutton " data-options="iconCls:'icon-tip'" disabled="false">启动</a>
						<a href="javascript:void(0);" class="easyui-linkbutton shutdown" data-options="iconCls:'icon-no'">关机</a>
						<a href="javascript:void(0);" class="easyui-linkbutton restart" data-options="iconCls:'icon-reload'">重启</a>
					<%} else{%>
						<a href="javascript:void(0);" class="easyui-linkbutton launch" data-options="iconCls:'icon-tip'">启动</a>
						<a href="javascript:void(0);" class="easyui-linkbutton shutdown" data-options="iconCls:'icon-no'">关机</a>
						<a href="javascript:void(0);" class="easyui-linkbutton restart" data-options="iconCls:'icon-reload'">重启</a>
					<%} %>
					&nbsp;
					<a href="javascript:void(0);" class="easyui-menubutton other-oper" data-options="menu:'#cloud_host_item_other_oper_menu', plain:false">其它操作</a>
				</div>
			</td>
		</tr>
	</table>
