...
<%--         <div class="msg"><img src="<%=request.getContextPath()%>/image/msgicon.png" width="20" height="20" style="vertical-align:middle;" /> 余额不足</div> --%>
        ...
        <table width="720" border="0" cellspacing="0" cellpadding="0" class="dtable">
          ...
          <tr>
            <td><%=cloudHost.getSysImageName()==null?"无系统信息":cloudHost.getSysImageName() %></td>
            <td></td>
            <td></td>
          </tr>
          <tr>
            <td>IP：
                <%=cloudHost.getType()==5?cloudHost.getVpcIp():"" %>
            <%=cloudHost.getType()==6?cloudHost.getVpcIp():"" %>
            <%=cloudHost.getType()==3?cloudHost.getOuterIp():"" %>        
            <%=cloudHost.getType()==2?cloudHost.getOuterIp():"" %>        
            </td>
            <td></td>
