...
// 	}
	function terminalUserColumnFormatter(value, row, index)
	{
		...
		return "<div row_index='"+index+"'>\
					<a href='javascript:void(0);' class='datagrid_row_linkbutton sendPhone_btn'>发送到手机</a>\
					<a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</>\
					<a href='javascript:void(0);' class='datagrid_row_linkbutton sendEmail_btn'>发送到邮箱</a>\
				</div>";
		}
	}
