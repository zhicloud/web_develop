...
<!-- 				<tr> -->
					...
					<td><a href="javascript:void(0);"  class="easyui-linkbutton" iconCls="icon-edit" id="email-edit-link">编辑</a></td>
				</tr>
				<tr>
					...
					<td><a href="javascript:void(0);"  class="easyui-linkbutton" iconCls="icon-edit" id="phone-edit-link">编辑</a></td>
				</tr>
			</table>
