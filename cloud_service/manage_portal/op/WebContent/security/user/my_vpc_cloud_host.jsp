...
function toBinding(id){
	...
	if(_ids.length==0){
		top.$.messager.alert("提示", "请选择需要绑定的项", "info", function(){
		});
		return;
	}
...
<div class="page">
  <div class="pageleft">
    ...
    <div class="wrap"><jsp:include page="/src/common/tpl/u_mcslider.jsp"></jsp:include></div>
      <div class="titlebar">
        <div class="tabbar l"><a href="<%=request.getContextPath() %>/bean/page.do?userType=4&bean=vpcService&method=managePage" onclick="self.location=document.referrer;"><img src="<%=request.getContextPath()%>/image/button_back.png" width="22" height="30" alt="返回" /><div style="margin-top:-30px;margin-left:25px;">VPC:<%=vpcVo.getDisplayName() %></div></a></div>
         <a href="javascript:void(0);" onclick="showCreateHosts();" style="cursor:pointer;margin-left:20px;" class="greenbutton r" title="重新给VPC创建主机">创建主机</a>  
         <a href="javascript:void(0);" onclick="showHosts();" style="cursor:pointer;margin-left:100px;" class="greenbutton r" title="从我的云主机添加到VPC">添加主机</a>      
        </div>
           ...
           <div class="l" style="width:120px;"><span class="bluebutton" style="width:105px; margin:0 15px 10px 0">选择已有主机</span></div>
            <div class="l" style="width:600px;display:inline; " id="hostSelected">
				...
				<div class="buttonbar" style="border-top:solid 1px #b2b2b2">
					...
					<a class="graybutton r" href="javascript:void(0);" onclick="$.unblockUI();">取消</a> 
					<div id="description_1" style="width:300px;padding-top:-10px;"></div>
				</div>   
			</div>
		</div>
		<div class="clear"></div>
