...
<%--       	<input type="hidden" id="terminalUser_id" name="terminalUser_id" value="<%=terminalUser.getId()%>" /> --%>
          ...
          <tr>
            ...
            <td width="335" style="padding:5px"><input name="old_password" id="old_password" type="password" onpaste='return false' class="textbox" style="height:28px; width:333px" onblur="checkOldPassword()"/></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td style="padding:5px"><input name="password" id="password" type="password" onpaste='return false' class="textbox" style="height:28px; width:333px" onblur="checkPassword()"/></td>
          </tr>
          <tr>
          	<td style="padding:0; line-height:16px">&nbsp;</td>
          ...
          <tr>
            ...
            <td style="padding:5px"><input name="confirm" id="confirm" type="password" onpaste='return false' class="textbox" style="height:28px; width:333px" onblur="checkPasswordConf()"/></td>
          </tr>
          <tr>
            <td style="padding:0; line-height:16px">&nbsp;</td>
        ...
        <a href="javascript:void(0);" class="bluelinebutton r" style="margin-right:5px" id="save_change_btn">提交</a>
      </div>
    </div>
    <div class="clear"></div>
