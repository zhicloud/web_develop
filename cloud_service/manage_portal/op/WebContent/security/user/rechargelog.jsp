      ...
      <div class="box" style="margin-top:30px;">
        ...
        <div class="r" style="width:720px;">
          <div class="titlebar2" style="text-align:right">
            <div class="tabbar l"><a href="javascript:void(0);"  id="consumption_list_show_btn">消费记录</a>　｜　<a href="javascript:void(0);" class="active" id="recharge_list_show_btn">充值记录</a></div>实际充值总额<b>：<%=all %></>元</b></div>
