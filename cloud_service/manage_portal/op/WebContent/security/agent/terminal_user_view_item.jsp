...
<%
	...
	Integer vpcTotal = (Integer)request.getAttribute("vpcTotal");
%>
    ...
    <div style="width:920px;">
      <div class="sidebar l" style="height:575px">
        <div style="width:238px;margin-top:15px;">
          ...
          <div style="display:block;margin:0 auto; width:238px; height:90px; background:url(<%=request.getContextPath()%>/image/sidebar_vpc_bg.png) no-repeat center center; padding:49px 0 15px 0; font-size:36px; line-height:40px; text-align:center; color:#626262;"><%=vpcTotal %></div> <a class="greenbutton" href="<%=request.getContextPath() %>/bean/page.do?userType=3&bean=vpcService&method=agentCreateVpnPage&terminalUserId=<%=terminalUser.getId()%>" style="margin:0 auto; width:80px; height:24px; line-height:24px; font-size:12px;">创建专属云</a>
        </div>
      </div>
      <div class="r" style="width:650px;">
        <div class="titlebar" style="width:650px;">
          <div class="l links"><a href="#" class="active">云主机</a> &nbsp;&nbsp; 
<%--           |&nbsp;&nbsp; <a href="<%=request.getContextPath()%>/bean/page.do?userType=<%=userType%>&bean=terminalUserService&method=agentViewDiskPage&terminalUserId=<%=terminalUser.getId()%>""  >云硬盘</a> &nbsp;&nbsp; --%>
          |&nbsp;&nbsp; <a href="<%=request.getContextPath()%>/bean/page.do?userType=<%=userType%>&bean=terminalUserService&method=agentViewVpcPage&terminalUserId=<%=terminalUser.getId()%>"  >专属云</a>
          </div>
        </div>
      ...
      <div class="blocks l">
        ...
        <div class="l"><a id="start_host_btn" href="#" class="greenbutton" style="width:48px">启动</a></div>
        <div class="l"><a id="shutdown_host_btn" href="#" class="orangebutton" style="width:48px">关机</a></div>
