...
<%
	...
	String terminalUserId = (String)request.getAttribute("userId");
	if(balance==null){
		balance="0";
	}
	if(totalPrice==null){
...
<script type="text/javascript" src="<%=request.getContextPath()%>/javascript/agent/createvpchost.js"></script> 
  ...
  <div class="pageleft">
    ...
    <div class="main">
      ...
      <form class="wizard" id="cloud_host_config_form"  action="<%=request.getContextPath()%>/bean/page.do" target="_blank" method="post">
        <input name="terminalUserId" value="<%=terminalUserId%>" type="hidden"></input>
