...
$(document).ready(function(){
	...
	$("#recharge_list_show_btn").click(function(){
		window.location.href="<%=request.getContextPath()%>/bean/page.do?userType=<%=userType%>&bean=accountBalanceService&method=toRechargeRecordPage";
	});
});
    ...
    <div style="width:920px; margin-top:30px;">
      ...
      <div class="r" style="width:650px;">
        <div class="titlebar" style="width:650px;">
          <div class="l links"><a href="#" class="active">扣款记录</a>　｜　<a href="#" id="recharge_list_show_btn">充值记录</a></div>
          <div class="r">扣款总额<b>：<%=all %>元</b></div>
        </div>
