...
$(document).ready(function(){   
	...
	$("#add_invoice_btn").click(function(){
		window.location.href="<%=request.getContextPath()%>/bean/page.do?userType=<%=userType%>&bean=invoiceService&method=addInvoicePageForAgent";
	});
...
<![endif]-->
	...
	<div class="page">
      ...
      <div class="titlebar" style="width:918px;">
      <div class="l">已开发票</div>
        <a href="javascript:void(0);" id="add_invoice_btn" class="greenbutton r">索取发票</a>
		</div>
