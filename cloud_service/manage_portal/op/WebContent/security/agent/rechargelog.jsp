    ...
    <div style="width:920px; margin-top:30px;">
      ...
      <div class="r" style="width:650px;">
        ...
        <table id="recharge_record_list" class="easyui-datagrid"  
            ...
            <thead>
              <tr>
                <th data-options="field:'changeTime',width:110" formatter="timeFormatter">充值时间</th>
                <th data-options="field:'payType',width:90" formatter="typeFormatter">充值方式</th>
                <th data-options="field:'amount',width:100">金额(元)</th>
                <th data-options="field:'description',width:250">详情</th>
              </tr>
            </thead>
            <tbody>
            </tbody>
