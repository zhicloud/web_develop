...
<html>
	...
	<body style="visibility:hidden;">
		<form id="big_form"  method="post">
			...
			<table id="agent_datagrid" class="easyui-datagrid" title="端口资源池管理"
				style=""
				data-options="
					url: '<%=request.getContextPath()%>/bean/ajax.do?userType=<%=userType%>&bean=resourcePoolService&method=queryPortPool',
					queryParams: {},
					rownumbers: true,
					striped: true,
					remoteSort:false,
...
<!-- 						<th data-options="checkbox:true"></th> -->
						<th field="name" width="50px" sortable=true>资源池名</th>
						<th field="region" formatter="formatRegion" width="30px">地域</th>
						<th field="count" width="40px" sortable=true>端口数(可用，总数)</th>
