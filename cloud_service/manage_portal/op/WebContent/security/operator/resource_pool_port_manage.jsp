...
<%@page import="com.zhicloud.op.app.pool.portPool.Port"%>
...
%>
<!DOCTYPE html>
<!-- resource_pool_port_manage.jsp -->
<html>
<head>
	<meta charset="UTF-8" />
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	<meta http-equiv="X-UA-Compatible" content="IE=9;IE=8;IE=7;" />
	<title>运营商管理员 - 端口资源池管理</title>
...
<div class="oper-wrap">
	<div class="tab-container">
		...
		<table id="agent_datagrid" class="easyui-datagrid" title="端口资源池管理" data-options="url: '<%=request.getContextPath()%>/bean/ajax.do?userType=<%=userType%>&bean=resourcePoolService&method=queryPortPool',queryParams: {},toolbar: '#toolbar',rownumbers: true,striped: true,remoteSort:false,fitColumns: true,pagination: true,pageSize: 20,view: createView(),onLoadSuccess: onLoadSuccess()">
			<thead>
				<tr>
					...
					<th data-options="field:'count',sortable:true,width:100">端口数(可用，总数)</th>
