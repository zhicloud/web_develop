...
<div id="terminal_user_mod_dlg_container">
	...
	<div id="terminal_user_mod_dlg" class="easyui-dialog" title="修改终端用户-[<%=terminalUser.getEmail()%>]"
		...
		<form id="terminal_user_mod_dlg_form" method="post">
           ...
           <tr style="height:50px;">
			...
			<tr style="height:50px;">
		      ...
		      <td class="inputcont"><input class="textbox inputtext" type="text" id="name" name="name" value="<%=terminalUser.getName()%>" onblur="checkName()" style="width:180px;height:24px"/></td>
