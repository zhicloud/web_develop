...
<%@page import="com.zhicloud.op.vo.ImageHostApplicationVO"%>
	...
	<div id="vpc_detail_dlg" class="easyui-dialog" title="申请详情"
		...
		<form id="vpc_detail_dlg_form" method="post">
			...
			<table border="0" style="width:90%; margin:0 auto 0 auto;">
				<tr>
					<td style="padding:5px;">孵化器名：<%=imageHostApplication.getName() %></td>
					<td style="padding:5px;">联系人：<%=imageHostApplication.getContacts() %></td>
				</tr>
				<tr>
					<td style="padding:5px;">联系人职位：<%=imageHostApplication.getContactsPosition() %></td>
					<td style="padding:5px;">联系人电话：<%=imageHostApplication.getContactsPhone() %></td>
				</tr>  
				<tr>
					<td style="padding:5px;" colspan="2">情况简介：<%=imageHostApplication.getSummary() %></td> 
				</tr>  
