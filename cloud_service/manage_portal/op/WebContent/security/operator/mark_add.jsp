...
<div id="mark_add_dlg_container">
	...
	<div id="mark_add_dlg" class="easyui-dialog" title="添加标签"
		...
		<form id="mark_add_dlg_form" method="post">
		    ...
		    <tr>
		      ...
		      <td class="inputcont"><input class="textbox inputtext" type="text" style="width:180px;height:24px" id="name" name="name" onblur="checkName()"/></td>
...
var _mark_add_dlg_scope_ = new function(){
	...
	self.save = function() {
		...
		ajax.remoteCall("bean://markService:addMark", 
			[ formData ],
			function(reply) {
