...
<head>
	...
	<style type="text/css">body{background:#f0f5f8;}</style>
</head>
...
<div class="oper-wrap">
	<div class="box" style="margin:0 auto">
		<div class="dbox l">
			...
			<div id="main_line_1" style="height:248px;border:1px solid #ccc;width: 300px;"></div>
		</div>
		<div class="dbox l f-ml10">
			<div class="title l">内存</div>
			<div class="title r"></div>
			<div class="clear"></div>
			<div class="unit">利用率</div>
			<div id="main_line_2" style="height:248px;border:1px solid #ccc;width: 300px;"></div>
		</div>
		<div class="dbox l f-ml10">
			...
			<div class="clear"></div>
			<div class="unit">利用率</div>
			<div id="main_line_3" style="height:248px;border:1px solid #ccc;width: 300px;"></div>
		</div>
		<div class="clear"></div>
	</div>
</div>
