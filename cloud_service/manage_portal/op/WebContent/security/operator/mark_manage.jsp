...
<html>
	...
	<body style="visibility:hidden;">
		<form id="big_form"  method="post">
			<table id="mark_datagrid" class="easyui-datagrid" title="标签管理"
				data-options="
					url: '<%=request.getContextPath()%>/bean/ajax.do?userType=<%=userType%>&bean=markService&method=queryAllMarks',
					queryParams: {},
					toolbar: '#toolbar',
					rownumbers: true,
					striped: true,
				...
				<thead>
					<tr>
						...
						<th field="name" width="100px" sortable=true>标签名</th>
						<th field="description" width="300px">描述</th>
						<th field="operate" formatter="markFormatter" width="30px">操作</th>
					</tr>
				</thead>
			</table>
			...
			<div id="toolbar" style="padding: 3px;">
				<div style="display: table; width: 100%;">
					<div style="display: table-cell; text-align: left">
						<a href="#" class="easyui-linkbutton" iconCls="icon-add" plain="true" id="add_mark_btn">添加</a> 
						<a href="#" class="easyui-linkbutton" iconCls="icon-remove" plain="true" id="del_mark_btn">删除</a>
					</div>
					<div style="display: table-cell; text-align: right;">
						<span style="position: relative; top: 2px;">标签名</span> 
						<input type="text" id="mark_account" style="position: relative; top: 2px; height: 18px;" /> 
						<a href="#" class="easyui-linkbutton" iconCls="icon-search" id="query_mark_btn">查询</a>
					</div>
				</div>
			</div>
	...
	// 布局初始化
	$("#mark_datagrid").height( $(document.body).height());
