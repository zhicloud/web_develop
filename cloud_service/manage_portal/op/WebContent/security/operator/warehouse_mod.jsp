		...
		<form id="warehouse_mod_dlg_form" method="post">
			...
			<table border="0" style="height: auto; margin: auto;">
				...
				<tr>
					...
					<td >
						<textarea name="description" id="description" rows="6" cols="44" style="resize:none;" onblur="checkDescription()"><%=warehouseVO.getDescription() %></textarea>
                    </td>
				...
				<tr>
					...
					<td >
						<input type="text" id="total_amount" style="position:relative; top:2px;" onblur="checkTotalAmount()"
