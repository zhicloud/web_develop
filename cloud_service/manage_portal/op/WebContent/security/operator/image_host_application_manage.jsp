...
%>
<!DOCTYPE html>
<!-- image_host_application_manage.jsp -->
<html>
<head>
	<meta charset="UTF-8" />
		...
		<div id="toolbar">
			<div style="display: table; width: 100%;">
				...
				<div style="display: table-cell; text-align: right;">
					...
					<span class="sear-row">
						<label class="f-ml10 f-mr5">公司全称</label> 
						<input type="text" id="name" class="messager-input" />
					</span>
					<span class="sear-row">
						<a class="easyui-linkbutton oper-btn-sty f-ml10" href="javascript:;" data-options="iconCls:'icon-search'" id="query_image_host_btn">查询</a>
					</span>
				</div>
			</div>
		</div>
		<table id="image_host_application_datagrid" class="easyui-datagrid" title="镜像主机申请管理" data-options="url: '<%=request.getContextPath()%>/bean/ajax.do?userType=<%=userType%>&bean=imageHostApplicationService&method=queryImageHostApplication',queryParams: {},toolbar: '#toolbar',rownumbers: false,striped: true,remoteSort:false,fitColumns: true,pagination: true,pageSize: 20,view:createView(),onLoadSuccess: onLoadSuccess()">
			<thead>
				<tr>
					<th data-options="checkbox:true"></th>
					<th data-options="field:'name',sortable:true,width:100">公司全称</th>
...
// 布局初始化
$("#image_host_application_datagrid").height( $(document.body).height()-20);
