...
<div id="exported_dlg_container">
	<div id="exported_dlg" class="easyui-dialog" title="消费记录 -[<%=account%>]"
		...
		<form id="big_form"  method="post">
			<table id="exported_datagrid" class="easyui-datagrid"
				style=""
				data-options="
					url: '<%=request.getContextPath()%>/bean/ajax.do?userType=<%=userType%>&bean=accountBalanceService&method=queryConsumptionRecord&id=<%=userId %>',
					queryParams: {},
					rownumbers: true,
					striped: true,
					remoteSort:false,
				...
				<thead>
					<tr>
						...
						<th data-options="field:'changeTime',width:140" formatter="timeFormat">消费时间</th>
						<th data-options="field:'payType',width:140" formatter="typeFormatter">消费方式</th>
						<th data-options="field:'resourceName',width:300">资源名</th>
						<th data-options="field:'amount',width:180" sortable=true>金额(元)</th>
					</tr>
				</thead>
			</table>
		</form>
