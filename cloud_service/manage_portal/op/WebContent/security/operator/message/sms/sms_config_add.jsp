...
<div id="sms_config_add_dlg_container">
	<div id="sms_config_add_dlg" class="easyui-dialog" title="新增配置" 
			style="
				width:480px;
				height:300px;
				padding:10px;
			...
			data-options="
				iconCls: 'icon-add',
				buttons: '#sms_config_add_dlg_buttons',
				modal: true,
				onMove:_sms_config_add_dlg_scope_.onMove,
				onClose: function(){
					$(this).dialog('destroy');
				},
				onDestroy: function(){
					delete _sms_config_add_dlg_scope_;
				}
			">
		<form id="sms_config_add_dlg_form" method="post">
		<table border="0" cellpadding="0" cellspacing="0">
		    <tr>
		        ...
		        <td class="inputcont"><input class="textbox inputtext" type="text" id="config_name" name="config_name" onblur="checkName()"/></td>
            ...
            <tr>
                ...
                <td class="inputcont"><input class="textbox inputtext" type="text" id="sms_id" name="sms_id" onblur="checkSmsId()"/></td>
            ...
            <tr>
                ...
                <td class="inputcont"><input class="textbox inputtext" type="text" id="service_url" name="service_url" onblur="checkServiceUrl()"/></td>
			...
			<tr>
				...
				<td class="inputcont"><input class="textbox inputtext" type="text" id="name" name="name" onblur="checkSender()"/></td>
	...
	<div id="sms_config_add_dlg_buttons">
		<a href="javascript:" class="easyui-linkbutton" id="sms_config_add_dlg_save_btn">
			&nbsp;保&nbsp;存&nbsp;
		</a>
		<a href="javascript:" class="easyui-linkbutton" id="sms_config_add_dlg_close_btn">
			&nbsp;关&nbsp;闭&nbsp;
		</a>
	</div>
</div>
...
//================================
var _sms_config_add_dlg_scope_ = {};		// 作用域
_sms_config_add_dlg_scope_.onMove = function(){
	var thisId = "#sms_config_add_dlg";
...
// 保存
_sms_config_add_dlg_scope_.save = function()
{
	var formData = $.formToBean(sms_config_add_dlg_form);
	ajax.remoteCall("bean://smsConfigService:addConfig",
		[formData],
		function(reply)
		{
			...
			{
				var data = $("#sms_config_add_dlg_container").parent().prop("_data_");
				$("#sms_config_add_dlg").dialog("close");
...
// 关闭
_sms_config_add_dlg_scope_.close = function()
{
	$("#sms_config_add_dlg").dialog("close");
};
...
// 保存
$("#sms_config_add_dlg_save_btn").click(function(){
	if(checkName() && checkSender() && checkSmsId() && checkPassword() && checkServiceUrl()){
		_sms_config_add_dlg_scope_.save();
	}
});

// 关闭
$("#sms_config_add_dlg_close_btn").click(function(){
	_sms_config_add_dlg_scope_.close();
});
