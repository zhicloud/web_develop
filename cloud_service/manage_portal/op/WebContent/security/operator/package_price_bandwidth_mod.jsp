...
%>
<!-- package_price_bandwidth_mod.jsp -->
...
var region = "<%=packagePrice.getRegion()%>";
...
function checkBandwidth(){
	...
	if(region==1){
		if(min_1>bandwidthValue || bandwidthValue > max_1){
			$("#tip-bandwidth-mod").html("<b>带宽大小超出设定范围["+min_1+"-"+max_1+"]M</b>");
			return false;
		}
	}
	if(region==2){
		if(min_2>bandwidthValue || bandwidthValue > max_2){
			$("#tip-bandwidth-mod").html("<b>带宽大小超出设定范围["+min_2+"-"+max_2+"]M</b>");
			return false;
		}
	}
	if(region==4){
		if(min_4>bandwidthValue || bandwidthValue > max_4){
			$("#tip-bandwidth-mod").html("<b>带宽大小超出设定范围["+min_4+"-"+max_4+"]M</b>");
			return false;
		}
	}
