	...
	<body style="visibility:hidden;">
		<form id="big_form"  method="post">
			...
			<table id="agent_datagrid" class="easyui-datagrid" title="主机资源池管理"
				style=""
				data-options="
					url: '<%=request.getContextPath()%>/bean/ajax.do?userType=<%=userType%>&bean=resourcePoolService&method=queryStoragePool',
					queryParams: {},
					rownumbers: true,
					striped: true,
					remoteSort:false,
				...
				<thead>
					<tr>
						...
						<th field="disk" width="30px" sortable=true>磁盘数[停止,告警,故障,正常]</th>
