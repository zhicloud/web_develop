...
<%@page import="com.zhicloud.op.vo.StoragePoolVO"%>
...
%>
<!DOCTYPE html>
<!-- resource_pool_storage_manage.jsp -->
<html>
<head>
	<meta charset="UTF-8" />
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	<meta http-equiv="X-UA-Compatible" content="IE=9;IE=8;IE=7;" />
	<title>运营商管理员 - 存储资源池管理</title>
...
<div class="oper-wrap">
	<div class="tab-container">
		...
		<table id="agent_datagrid" class="easyui-datagrid" title="存储资源池管理" data-options="url: '<%=request.getContextPath()%>/bean/ajax.do?userType=<%=userType%>&bean=resourcePoolService&method=queryStoragePool',queryParams: {},toolbar: '#toolbar',rownumbers: true,striped: true,remoteSort:false,fitColumns: true,pagination: true,pageSize: 20,view: createView(),onLoadSuccess: onLoadSuccess()">
			<thead>
				<tr>
					<th data-options="field:'name',sortable:true,width:100">资源池名</th>
					<th data-options="field:'region',formatter:formatRegion,width:100">地域</th>
					<th data-options="field:'cpuCount',sortable:true,formatter:formatCpuCore,width:100">CPU核数</th>
					<th data-options="field:'cpuUsage',sortable:true,formatter:formatUsage,width:100">CPU利用率</th>
					<th data-options="field:'memory',sortable:true,formatter:formatArray,width:100">内存[可用,总量]</th>
					<th data-options="field:'memoryUsage',sortable:true,formatter:formatUsage,width:100">内存利用率</th>
					<th data-options="field:'diskVolume',sortable:true,formatter:formatArray,width:100">磁盘[可用,总量]</th>
					<th data-options="field:'diskUsage',sortable:true,formatter:formatUsage,width:100">磁盘利用率</th>
					<th data-options="field:'disk',sortable:true,width:150">磁盘数[停止,告警,故障,正常]</th>
