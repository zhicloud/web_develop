...
<div class="oper-wrap">
	<div class="tab-container">
		...
		<table id="agent_datagrid" class="easyui-datagrid" title="计算资源池管理" data-options="url: '<%=request.getContextPath()%>/bean/ajax.do?userType=<%=userType%>&bean=resourcePoolService&method=queryComputerPool',queryParams: {},toolbar: '#toolbar',rownumbers: true,striped: true,remoteSort:false,fitColumns: true,pagination: true,pageSize: 20,view: createView(),onLoadSuccess: onLoadSuccess()">
			<thead>
				<tr>
					<th data-options="field:'name',width:60">资源池名</th>
					<th data-options="field:'region',formatter:formatRegion,width:80">地域</th>
					<th data-options="field:'cpu_count_text',sortable:true,formatter:formatRegion,width:100">CPU核数</th>
