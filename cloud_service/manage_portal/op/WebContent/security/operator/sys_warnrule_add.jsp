...
<!-- sys_warnrule_add.jsp -->
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>预警规则管理 - 新增配置</title>
...
<div id="agent_add_dlg_container">
	<div id="agent_add_dlg" class="easyui-dialog" title="添加预警配置"
  ...
  <table border="0" cellpadding="0" cellspacing="0">
      ...
      <td class="inputcont"><input class="messager-input" type="text" id="name" name="name" onblur="checkName()"/></td>
      ...
      <td class="inputcont"><input class="messager-input" type="text" id="code" name="code" onblur="checkCode()"/></td>
      ...
      <td class="inputcont"><input class="messager-input" type="text" id="frequency" name="frequency" onblur="checkFrequency()"/></td>
      ...
      <td class="inputcont"><input class="messager-input" type="text" id="sampletime" name="sampletime" onblur="checkSampletime()"/></td>
    ...
    <tr>
      ...
      <td class="inputcont"><input class="messager-input" type="text" id="notify_phone" name="notify_phone" onblur="checkPhone()"/></td>
    ...
    <tr>
      ...
      <td class="inputcont"><input class="messager-input" type="text" id="notify_email" name="notify_email" onblur="checkEmail()"/></td>
...
function checkSendtime(){
	...
	if(!/^[0-9]{2}:[0-9]{2}:[0-9]{2}$/.test(sendtime)){
		$("#operator-tip-sendtime").html("<b>请输入格式为【24:00:00】格式的定时发送时间</b>");
		return false;
	}
