...
<html>
	...
	<body style="visibility:hidden;">
		<form id="big_form"  method="post">
			...
			<table id="egg_plan_datagrid" class="easyui-datagrid" title="蛋壳计划管理"
				data-options="
					url: '<%=request.getContextPath()%>/bean/ajax.do?userType=<%=userType%>&bean=eggPlanService&method=queryEggPlan',
					queryParams: {},
					toolbar: '#toolbar',
					rownumbers: true,
					striped: true,
				...
				<thead>
					<tr>
						...
						<th field="incubatorName" width="50px" sortable=true>孵化器名或者园区名</th>
			...
			<div id="toolbar" style="padding: 3px;">
				<div style="display: table; width: 100%;">
					...
					<div style="display: table-cell; text-align: right;">
						...
						&nbsp;&nbsp;&nbsp;&nbsp;
						<span style="position: relative; top: 2px;">孵化器或园区名称</span> 
						<input type="text" id="name" style="position: relative; top: 2px; height: 18px;" /> 
						<a href="#" class="easyui-linkbutton" iconCls="icon-search" id="query_agg_plan_btn">查询</a>
					</div>
				</div>
			</div>
	...
	// 布局初始化
	$("#egg_plan_datagrid").height( $(document.body).height());
