			...
			<table id="agent_datagrid" class="easyui-datagrid" title="代理商管理"
				...
				<thead>
					<tr>
						...
						<th field="markName"   width="100px" sortable=true>标签</th>
						<th field="percentOff"   width="100px" sortable=true>折扣率(%)</th>
						<th field="accountBalance"   width="100px" sortable=true>账户余额</th>
						<th field="recharge"   width="100px" sortable=true>累计充值</th>
						<th field="consum"   width="100px" sortable=true>累计消费</th>
						<th field="status" formatter="formatStatus" width="80px" sortable=true>状态</th>
						<th field="create_time" formatter="formatCreateTime" width="100px">创建时间</th>
						<th field="operate" formatter="agentColumnFormatter" width="300px">操作</th>
					</tr>
				</thead>
			</table>
			...
			<div id="toolbar" style="padding: 3px;">
				<div style="display: table; width: 100%;">
					<div style="margin-bottom:5px;">
						...
						<a href="#" class="easyui-linkbutton" iconCls="icon-undo" plain="true" id="user_agent_btn">查看代理商用户</a>
					...
					到 <input class="easyui-datebox" type="text" name = "create_time_to" id="create_time_to" style="width:100px"/><br>
