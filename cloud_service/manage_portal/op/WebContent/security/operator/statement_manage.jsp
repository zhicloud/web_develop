...
<div class="oper-wrap">
	<div style="background-color:#fff;">
		<table style="width:280px; height:80px; padding:5px;">
			<tr><td>当月新开用户:</td><td><%=results.get("newUserCount") %>位/<%=results.get("userCount") %>位</td></tr>
			<tr><td>总收入:</td><td><%=results.get("incomeCount") %>元</td></tr>
			<tr><td>其中:&nbsp;包月付费:&nbsp;<%=results.get("incomeCountForMonthly") %>元</td><td>按量付费:&nbsp;<%=results.get("incomeCountForDosage") %>元</td></tr>
		</table>
	</div>
	
	<div style="height:50px;background:#fff; padding:0 5px;border-bottom:1px solid #ccc;border-top:1px solid #ccc;">
		<table style="width:400px; height:50px;margin-bottom: 10px;">
			<tr><td>当前云主机:&nbsp;<%=results.get("cloudHostCount")%>&nbsp;台</td><td></td></tr>
		</table>
	</div>
	
	<div style="height:250px;padding-top:10px;background:#fff;">
		<div id="main_pie_1" style="height:250px;border-right:1px solid #ccc;width: 250px; margin-left: 20px;float: left;"></div>
		<div id="main_pie_2" style="height:250px;border-right:1px solid #ccc;width: 250px; margin-left: 0px; float: left;"></div> 
		<div id="main_pie_3" style="height:250px;width: 250px; margin-left: 0px; float: left;"></div>
	</div>
</div>
