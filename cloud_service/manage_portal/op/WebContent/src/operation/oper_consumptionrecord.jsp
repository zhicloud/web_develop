	...
	<div class="nav-list">
		...
		<div class="nav-item">
			...
			<ul class="list-unstyled submenu open">
				...
				<li><a class="sub-sty current" href="oper_consumptionrecord.jsp">消费记录</a></li>
			</ul>
		</div>
		<div class="nav-item">
...
<script type="text/javascript" src="<%=request.getContextPath()%>/src/operation/js/oper_consumptionrecord.js"></script>
</body>
</html>