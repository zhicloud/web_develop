	...
	<div class="nav-list">
		...
		<div class="nav-item">
			...
			<ul class="list-unstyled submenu open">
				...
				<li><a class="sub-sty current" href="oper_operationlog.jsp">操作日志</a></li>
...
<script type="text/javascript" src="<%=request.getContextPath()%>/src/operation/js/oper_operationlog.js"></script>
</body>
</html>