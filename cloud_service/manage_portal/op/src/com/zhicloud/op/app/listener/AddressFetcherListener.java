...
import com.zhicloud.op.app.listener.task.AddressFetcherRunnable;
...
public class AddressFetcherListener implements Servlet {
	...
	public void init(ServletConfig config) throws ServletException {
		...
		for (RegionData region : regions) {
			AddressFetcherRunnable addressFetcherRunnable = new AddressFetcherRunnable(region.getId(), intervalTime);
