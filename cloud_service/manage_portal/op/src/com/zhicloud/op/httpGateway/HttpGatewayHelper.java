...
import com.zhicloud.op.common.util.HttpUtil;
import com.zhicloud.op.common.util.HttpUtil.InputStreamHandler;
import com.zhicloud.op.common.util.StreamUtil;
import com.zhicloud.op.common.util.StringUtil;
import com.zhicloud.op.exception.AppException;
import com.zhicloud.op.exception.ErrorCode;
import com.zhicloud.op.httpGateway.verifyMethod.VerifyMethod;
import com.zhicloud.op.httpGateway.verifyMethod.VerifyMethodFactory;
...
public class HttpGatewayHelper
{
    ...
    public JSONObject hostQuery(int range, String target) throws MalformedURLException, IOException
    {
        String url = this.baseUrl + "host?";
        url += "command=query&";
        url += "session_id="+this.sessionId+"&";
        ...
        // 参数
        Map<String, String> postDataMap = new LinkedHashMap<String, String>();
        postDataMap.put("range", String.valueOf(range));
...
//  }
    ...
    public JSONObject isoImageUpload(String name, String target, String description, String group, String user, String callback) throws MalformedURLException, IOException
    {
        String url = this.baseUrl + "isoImage?";
        url += "command=upload&";
        url += "session_id="+this.sessionId+"&";
    ...
    public JSONObject computePoolCreate(String name, int network_type, String network, int disk_type, String disk_source) throws MalformedURLException, IOException
    {
        String url = this.baseUrl + "computePool?";
        url += "command=create&";
        url += "session_id="+this.sessionId+"&";
    ...
    public JSONObject computePoolCreate(String name, int network_type, String network, int disk_type, String disk_source, Integer[] mode) throws MalformedURLException, IOException
    {
        String url = this.baseUrl + "computePool?";
        url += "command=create&";
        url += "session_id="+this.sessionId+"&";
    ...
    public JSONObject computePoolModify(String uuid, String name, int networkType, String network, int diskType, String diskSource, int option, String callback) throws MalformedURLException, IOException
    {
        String url = this.baseUrl + "computePool?";
        url += "command=modify&";
        url += "session_id="+this.sessionId+"&";
    ...
    public JSONObject computePoolModify(String uuid, String name, int networkType, String network, int diskType, String diskSource, Integer[] mode, int option, String callback) throws MalformedURLException, IOException
    {
        String url = this.baseUrl + "computePool?";
        url += "command=modify&";
        url += "session_id="+this.sessionId+"&";
    ...
    public JSONObject addressPoolAddResource(String pool, String[] ip, Integer[] range) throws MalformedURLException, IOException
    {
        String url = this.baseUrl + "addressPool?";
        url += "command=add_resource&";
        url += "session_id="+this.sessionId+"&";
        ...
        postDataMap.put("range", StringUtil.joinWrap(range));
        byte[] encryptParam = encrypt(postDataMap);
    ...
    public JSONObject portPoolAddResource(String pool, String[] ip, Integer[] range) throws MalformedURLException, IOException
    {
        String url = this.baseUrl + "portPool?";
        url += "command=add_resource&";
        url += "session_id="+this.sessionId+"&";
    ...
    //------------snapshot pool manage--------------
    
    public JSONObject snapshotPoolQuery(String callback) throws MalformedURLException, IOException {
        String url = this.baseUrl + "snapshot_pool?";
        url += "command=query&";
        url += "session_id=" + this.sessionId + "&";

        if (logger.isDebugEnabled()) {
            logger.info("querySnapshotPool() -> url=[" + url + "]");
        }
    ...
    public JSONObject snapshotPoolCreate(String name, String callback) throws MalformedURLException, IOException {
        String url = this.baseUrl + "snapshot_pool?";
        url += "command=create&";
        url += "session_id=" + this.sessionId + "&";

        if (logger.isDebugEnabled()) {
            logger.info("snapshotPoolCreate() -> url=[" + url + "]");
        }
    ...
    public JSONObject snapshotPoolModify(String uuid, String name, String callback) throws MalformedURLException, IOException {
        String url = this.baseUrl + "snapshot_pool?";
        url += "command=modify&";
        url += "session_id=" + this.sessionId + "&";

        if (logger.isDebugEnabled()) {
            logger.info("snapshotPoolModify() -> url=[" + url + "]");
        }
    ...
    public JSONObject snapshotPoolDelete(String uuid, String callback) throws MalformedURLException, IOException {
        String url = this.baseUrl + "snapshot_pool?";
        url += "command=delete&";
        url += "session_id=" + this.sessionId + "&";

        if (logger.isDebugEnabled()) {
            logger.info("snapshotPoolDelete() -> url=[" + url + "]");
        }
    ...
    public JSONObject snapshotPoolAddNode(String pool, String nodeName, String callback) throws MalformedURLException, IOException {
        String url = this.baseUrl + "snapshot_pool?";
        url += "command=add_node&";
        url += "session_id=" + this.sessionId + "&";

        if (logger.isDebugEnabled()) {
            logger.info("snapshotPoolAddNode() -> url=[" + url + "]");
        }

        // 参数
        Map<String, String> postDataMap = new LinkedHashMap<String, String>();
        postDataMap.put("pool", pool);
        postDataMap.put("name", nodeName);
        postDataMap.put("callback", callback);
    ...
    public JSONObject snapshotPoolRemoveNode(String pool, String nodeName, String callback) throws MalformedURLException, IOException {
        String url = this.baseUrl + "snapshot_pool?";
        url += "command=remove_node&";
        url += "session_id=" + this.sessionId + "&";

        if (logger.isDebugEnabled()) {
            logger.info("snapshotPoolRemoveNode() -> url=[" + url + "]");
        }
    ...
    public JSONObject snapshotPoolQueryNode(String pool, String callback) throws MalformedURLException, IOException {
        String url = this.baseUrl + "snapshot_pool?";
        url += "command=query_node&";
        url += "session_id=" + this.sessionId + "&";

        if (logger.isDebugEnabled()) {
            logger.info("snapshotPoolQueryNode() -> url=[" + url + "]");
        }
    ...
    public JSONObject snapshotQuery(String uuid, String callback) throws MalformedURLException, IOException {
        String url = this.baseUrl + "snapshot?";
        url += "command=query&";
        url += "session_id=" + this.sessionId + "&";

        if (logger.isDebugEnabled()) {
            logger.info("snapshotQuery() -> url=[" + url + "]");
        }
    ...
    public JSONObject snapshotCreate(String target, String name, String callback) throws MalformedURLException, IOException {
        String url = this.baseUrl + "snapshot?";
        url += "command=create&";
        url += "session_id=" + this.sessionId + "&";

        if (logger.isDebugEnabled()) {
            logger.info("snapshotCreate() -> url=[" + url + "]");
        }
    ...
    public JSONObject snapshotDelete(String uuid, String callback) throws MalformedURLException, IOException {
        String url = this.baseUrl + "snapshot?";
        url += "command=delete&";
        url += "session_id=" + this.sessionId + "&";

        if (logger.isDebugEnabled()) {
            logger.info("snapshotDelete() -> url=[" + url + "]");
        }
    ...
    public JSONObject snapshotResume(String uuid, String callback) throws MalformedURLException, IOException {
        String url = this.baseUrl + "snapshot?";
        url += "command=resume&";
        url += "session_id=" + this.sessionId + "&";

        if (logger.isDebugEnabled()) {
            logger.info("snapshotResume() -> url=[" + url + "]");
        }
    ...
    public JSONObject startMonitor(int level, String[] target, String callback) throws MalformedURLException, IOException {
