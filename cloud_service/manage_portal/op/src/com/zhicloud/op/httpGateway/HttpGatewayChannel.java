...
public class HttpGatewayChannel
{
	...
	public synchronized JSONObject hostQuery(int range, String target) throws MalformedURLException, IOException
	{
		try
		{
			checkSessionRefresh();
			JSONObject result = helper.hostQuery(range, target);
			if( HttpGatewayReturnCode.SESSION_NOT_FOUND.equals(HttpGatewayResponseHelper.getReturnCode(result)) )
			{
				helper = null;
			}
...
//	}
	...
	public synchronized JSONObject computePoolCreate(String name, int network_type, String network, int disk_type, String disk_source, Integer[] mode) throws MalformedURLException, IOException
	{
		try
		{
			checkSessionRefresh();
			JSONObject result = helper.computePoolCreate(name, network_type, network, disk_type, disk_source, mode);
			if( HttpGatewayReturnCode.SESSION_NOT_FOUND.equals(HttpGatewayResponseHelper.getReturnCode(result)) )
			{
				helper = null;
			}
	...
	public synchronized JSONObject computePoolModify(String uuid, String name, int networkType, String network, int diskType, String diskSource, int option, String callback) throws MalformedURLException, IOException
	{
		try
		{
			checkSessionRefresh();
			JSONObject result = helper.computePoolModify(uuid, name, networkType, network, diskType, diskSource, option, callback);
			if( HttpGatewayReturnCode.SESSION_NOT_FOUND.equals(HttpGatewayResponseHelper.getReturnCode(result)) )
			{
				helper = null;
			}
	...
	public synchronized JSONObject computePoolModify(String uuid, String name, int networkType, String network, int diskType, String diskSource, Integer[] mode, int option, String callback) throws MalformedURLException, IOException
	{
		try
		{
			checkSessionRefresh();
			JSONObject result = helper.computePoolModify(uuid, name, networkType, network, diskType, diskSource, mode, option, callback);
			if( HttpGatewayReturnCode.SESSION_NOT_FOUND.equals(HttpGatewayResponseHelper.getReturnCode(result)) )
			{
				helper = null;
			}
	...
	public synchronized JSONObject addressPoolAddResource(String pool, String[] ip, Integer[] range) throws MalformedURLException, IOException
	{
		try
		{
			checkSessionRefresh();
	...
	public synchronized JSONObject portPoolAddResource(String pool, String[] ip, Integer[] range) throws MalformedURLException, IOException
	{
		try
		{
			checkSessionRefresh();
			JSONObject result = helper.portPoolAddResource( pool,  ip,  range);
			if( HttpGatewayReturnCode.SESSION_NOT_FOUND.equals(HttpGatewayResponseHelper.getReturnCode(result)) )
			{
				helper = null;
			}
	...
	public synchronized JSONObject startMonitor(int level, String[] target, String callback) throws MalformedURLException, IOException {
		try
		{
			checkSessionRefresh();
