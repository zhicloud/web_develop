...
public class HttpGatewayAsyncChannel extends HttpGatewayChannelExt {
	...
	public synchronized JSONObject computePoolModify(String uuid, String name, int networkType, String network, int diskType, String diskSource, int option) throws MalformedURLException, IOException {
		return this.computePoolModify(uuid, name, networkType, network, diskType, diskSource, option, this.callback);
	}

	public synchronized JSONObject computePoolModify(String uuid, String name, int networkType, String network, int diskType, String diskSource, Integer[] mode, int option) throws MalformedURLException, IOException {
		return this.computePoolModify(uuid, name, networkType, network, diskType, diskSource, mode, option, this.callback);
	}
