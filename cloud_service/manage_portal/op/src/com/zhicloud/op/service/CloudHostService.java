...
public interface CloudHostService
{
	 ...
	 * @since JDK 1.7
	 */
	public void queryCloudHostPorts(HttpServletRequest request,HttpServletResponse response);
	public String modifyDescriptionPage(HttpServletRequest request, HttpServletResponse response);
	public MethodResult modifyDescription(Map<String, Object> parameter);
	
	/**
	 * @Description:查询用户云主机信息，不分页
	 * @param request
	 * @param response
	 * @return List<CloudHostVO>
	 */
    public List<CloudHostVO> queryCloudHostForExport(HttpServletRequest request, HttpServletResponse response);
	...
	* @throws
	...
	/**
	 * 
	* @Title: getCloudHostRestartStatus 
	* @Description:查询主机重启状态
	* @param @param hostId
	* @param @return      
	* @return MethodResult     
	* @throws
