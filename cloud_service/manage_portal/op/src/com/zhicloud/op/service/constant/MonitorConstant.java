...
public class MonitorConstant {
    ...
    // 服务器存放常量,String是机架ID
    public static Map<String, JSONArray> serverMap = Collections.synchronizedMap(new LinkedHashMap<String, JSONArray>());
    ...
    // 服务器资源利用率超过警告阀值的次数
    public static Map<String, Integer> server_map_warn_count = Collections.synchronizedMap(new LinkedHashMap<String, Integer>());
    // 云主机资源利用率超过警告阀值的次数
    public static Map<String, Integer> host_map_warn_count = Collections.synchronizedMap(new LinkedHashMap<String, Integer>());
    // 服务器资源利用率超过故障阀值的次数
    public static Map<String, Integer> server_map_error_count = Collections.synchronizedMap(new LinkedHashMap<String, Integer>());
    // 云主机资源利用率超过故障阀值的次数
    public static Map<String, Integer> host_map_error_count = Collections.synchronizedMap(new LinkedHashMap<String, Integer>());
    // 服务器或云主机故障上次发送邮件的时间
    ...
    // 告警规则配置存放常量
    public static Map<String, SysWarnRuleVO> rulevo = Collections.synchronizedMap(new LinkedHashMap<String, SysWarnRuleVO>());
    // 故障规则集合
    public static Map<String, List<SysWarnValueVO>> rule_values = Collections.synchronizedMap(new LinkedHashMap<String, List<SysWarnValueVO>>());
    // 区分服务器和云主机标示常量
