...
//	public static final Integer GLOBAL_REGION_4_HONGKONG  = 4;
	...
	public static final Integer CLOUD_DISK_TYPE_1_TERMINAL_USER     = 1;
	public static final Integer CLOUD_DISK_TYPE_2_AGENT         = 2;
	...
	//请求路径(数据库监控)
	public static final String MAPPING_URLMONITOR = "/op/server/monitor.do";
	public static final String METHOD_POST = "POST";
	public static final String CHARSET = "UTF-8";
	public static final String GET_CPU_MEM = "0";
	public static final String GET_DISK_DATA = "1";
  ...
  //备份参数
  public static final Integer FULL_BACKUP_MODE = 0;    //全备份模式
  public static final Integer PART_BACKUP_MODE = 1;    //部分备份模式

  public static final Integer OS_BACKUP_DISK = 0;      //系统盘备份
  public static final Integer DATA_BACKUP_DISK = 1;    //数据盘备份
