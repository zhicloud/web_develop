...
public interface VpcBaseInfoMapper {
	 ...
	 * @since JDK 1.7
	 */
	public List<VpcBaseInfoVO> getVpcByAgentId(String agentId);
	/** 
	 * 通过userid查询vpc数量
	 * 
	 * @param condition
	 * @return
	 */
	public int getCountByUserId(Map<String,Object> condition);
 	/**
	 * 
	 * updateVpcPrice: 更新vpc的价格
	 *
	 * @author sasa
	 * @param condition
	 * @return int
	 ...
	 * @return
	 */
	public int getVpcCountByTime(Map<String,Object> condition);
}
