...
<!-- 						</td> -->
				...
				<table style="width:100%; margin:0 auto 0 auto;">
					<tr>
						...
						<td >
							<input id="address_of_recharge" type="text" name="address_of_recharge"  value=""  style="width:400px"/>
						</td> 
					</tr>
					<tr>
						<td width="140px">
				...
				<table style="width:100%; margin:0 auto 0 auto;">
					<tr>
						...
						<td >
							<input id="server_binding_request" type="text" name="server_binding_request"  value=""  style="width:400px"/>
						</td> 
					</tr> 
					<tr>
						<td width="140px">
						...
						<td style="color:blue;">
							（此属性将用于域名绑定功能，值为形如："http://127.0.0.1:8081"的字符串）
						</td>
					</tr>
					<tr>
						<td colspan="95" style="padding: 10px 0 10px 0;">
	...
	var _package_option_upper_dlg_scope_ = new function(){
		...
		$("#address_of_recharge").val("<%=AppProperties.getValue("address_of_recharge", "")%>"); 
		$("#cd_max_ports").val("<%=AppProperties.getValue("cd_max_ports", "")%>"); 
		$("#server_binding_request").val("<%=AppProperties.getValue("server_binding_request", "")%>"); 
...
// 			var   r =/^(?!0+(?:\.0+)?$)(?:[1-9]\d*|0)(?:\.\d{1,2})?$/;
			...
			var addressOfRecharge = new String($("#address_of_recharge").val()).trim();
			if(addressOfRecharge==null || addressOfRecharge==""){
				top.$.messager.alert("警告","银联支付地址不能为空",'warning',function(){
					window.location.reload();
				});
				return ; 
			}
			...
			{
				top.$.messager.alert("警告","成都主机最大端口数必须为3-100的正整数",'warning',function(){
					window.location.reload();
				});
				return ;
			}
			
			var server_binding_request = $("#server_binding_request").val().trim(); 
			if(server_binding_request==null || server_binding_request==""){
