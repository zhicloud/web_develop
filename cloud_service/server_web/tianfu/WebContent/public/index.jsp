  ...
  <div class="pagewhite">
    ...
    <div class="pagemain">
      <div class="feature" style="height:450px;">
        <ul style="width:600%;">
          <li style="width:16.66%;height:450px;background:#333958 url(image/banner_free.png) no-repeat center center"><a href="buy.do" style="display:block; width:100%; height:100%; text-align:center">&nbsp;</a></li>
          <li style="width:16.66%;height:450px;background:#3188fa url(image/bannerb.png) no-repeat center center"><a href="cloudsever.do" style="display:block; width:100%; height:100%; text-align:center">&nbsp;</a></li>
          <li style="width:16.66%;height:450px;background:#cee6ff url(image/banner_2_bg.png)">
          ...
          <li style="width:16.66%;height:450px;background:#13bd9c url(image/bannerc.png) no-repeat center center"><a href="solution.do" style="display:block; width:100%; height:100%; text-align:center">&nbsp;</a></li>
          <li class="index5" style="width:16.66%;height:450px; text-align:center"><img src="image/banner_5.png" width="1000" height="450" /></li>
          <li style="width:16.7%;height:450px;background:#333958 url(image/banner_free.png) no-repeat center center"><a href="buy.do" style="display:block; width:100%; height:100%; text-align:center">&nbsp;</a></li>
        </ul>
