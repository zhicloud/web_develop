	...
	public void sendEmail(Map<String, Object> terminalUserData) {
		...
		try {
			...
			"<body>"
					...
					+ "<br>"
					+ "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;您好！<br>"
					+ "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;感谢您注册致云科技云端在线，您只需点击下面链接激活您的帐号，便可以体验我们的服务！"
					+ "<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='"+AppProperties.getValue("address_of_this_system", "/")+"user/sendmail.do?str="
					+ str
					+ "'>"+AppProperties.getValue("address_of_this_system", "/")+"user/sendmail.do?str="
					+ str
					+ "</a>"
		...
		try {
			...
			String tcontent =
					"<body>"
							...
							+ "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; https://www.zhicloud.com/agent.do <br> "
							+ "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 登录账户是:"+user.get("email").toString()+" &nbsp;  初始密码为:"+password+"<br>"
							+ "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(为了您账号的安全，请登录后及时修改)<br>"
							+ "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;如需帮助，请下载以下致云代理商管理平台操作指南<br>"
							+ "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='"+AppProperties.getValue("address_of_this_system", "")+"loadWord.do'>致云代理商管理平台操作指南</a><br>"
 							+ "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;请勿把这封邮件泄露给其他非相关人士！<br>"
		...
		try {
			...
			if(ttitle.contains("零")){
				tcontent =
						...
						+ "<br>"
						+ "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;您好！<br>"
						+ "<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;您的账户余额已为零，目前已暂停您的所有产品服务，为了不影响您的业务情况，请"
						+ "您尽快充值开通服务，谢谢。"
						+ "<br>"
						+ "<br>Zhicloud·致云科技感谢您的支持！"
						+ "</body>";
			}else{
				tcontent =
						"<body>"
						...
						+ "<br>"
						+ "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;您好！<br>"
						+ "<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;您的账户余额已不足，剩余余额还可供您当前所有产品使用"+day+"天，" +day+"天后所有产品将"
						+ "<br>会被暂停服务，为了不影响您的业务情况，请您及时充值，谢谢。"
						+ "<br>"
						+ "<br>Zhicloud·致云科技感谢您的支持！"
						+ "</body>";
			}
