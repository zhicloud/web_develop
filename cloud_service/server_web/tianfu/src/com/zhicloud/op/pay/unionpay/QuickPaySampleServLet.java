...
public class QuickPaySampleServLet extends HttpServlet {
	...
	public static String service(Map<String, String> sParaTemp) {  
		String orderId =  sParaTemp.get("out_trade_no");
		BigDecimal total = new BigDecimal(sParaTemp.get("total_fee"));
		...
		String[] valueVo = new String[]{
	            ...
	            "充值",//商品名称
	            total.toString().split("\\.")[0],//商品单价 单位：分
	            "1",//商品数量
	            "0",//折扣 单位：分
	            "0",//运费 单位：分
	            orderId,//订单号（需要商户自己生成）
	            total.toString().split("\\.")[0],//交易金额 单位：分
	            "156",//交易币种
