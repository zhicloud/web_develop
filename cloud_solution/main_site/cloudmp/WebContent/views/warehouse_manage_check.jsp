      ...
      <div class="row">
        ...
        <div id="content" class="col-md-12">
          ...
          <div class="pageheader">
            ...
            <h2><i class="fa fa-desktop"></i>仓库最小库存管理</h2>
              ...
              <div class="col-md-12">
                ...
                <section class="tile color transparent-black">
                  ...
                  <div class="tile-header">
                    <h3><a href="<%=request.getContextPath() %>/warehouse/all"    style="color:#FAFAFA;cursor:pointer;padding-right:10px;"> <i class="fa fa-reply"></i></a>输入配置</h3>
                    <div class="controls">
                  ...
                  <div class="tile-body">
                    ...
                    <form class="form-horizontal" role="form" parsley-validate id="basicvalidations" action="<%=request.getContextPath() %>/warehouse/updatecheck" method="post"   >
                      ...
                      <div class="form-group">
                        <label for="input01" class="col-sm-2 control-label">最小库存*</label>
                        <div class="col-sm-4">
                          <input type="text" class="form-control" id="minimum" name="minimum" parsley-type="number" maxlength="3" parsley-trigger="change" value="${minimum }" parsley-required="true" parsley-max="100" parsley-min="0">
                         (最小库存为0则不会定时检查)
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-sm-4">
                          <input type="text" class="form-control" id="hour" name="hour" parsley-type="number" maxlength="2" parsley-trigger="change" value="${hour }" parsley-required="true" parsley-max="23" parsley-min="0">
                        </div>
                      </div> 
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-4">
                          <input type="text" class="form-control" id="min" name="min"  parsley-type="number" maxlength="2" parsley-trigger="change" value="${min }" parsley-required="true" parsley-max="59" parsley-min="0">
                        </div>
                      </div> 
                      <div class="form-group">
                        <label for="input01" class="col-sm-2 control-label">秒*</label>
                        <div class="col-sm-4">
                          <input type="text" class="form-control" id="sec" name="sec"  parsley-type="number" maxlength="2" parsley-trigger="change" value="${sec }" parsley-required="true" parsley-max="59" parsley-min="0">
                        </div>
                      </div> 
