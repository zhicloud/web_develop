      ...
      <div class="row">
        ...
        <div id="content" class="col-md-12">
          ...
          <div class="pageheader">
            ...
            <h2><i class="fa fa-server"></i> 创建镜像</h2>
              ...
              <div class="col-md-12">
                ...
                <!-- tile widget -->
                  ...
                  <div class="tile-header">
                    <h3><a href="<%=request.getContextPath() %>/image/imagelist"    style="color:#FAFAFA;cursor:pointer;padding-right:10px;"> <i class="fa fa-reply"></i></a>输入镜像信息</h3>
                    <div class="controls">
                  ...
                  <div class="tile-body">
                    ...
                    <form class="form-horizontal" role="form" parsley-validate id="basicvalidations" action="<%=request.getContextPath() %>/image/add" method="post"   >
                      
                      <div class="form-group">
                        <label for="input01" class="col-sm-2 control-label">镜像名称 *</label>
                        <div class="col-sm-4">
                          <input type="text" class="form-control" id="name" name="name"  parsley-trigger="change" parsley-required="true" parsley-checkdesktopimagename="true" parsley-minlength="2" parsley-maxlength="50" parsley-validation-minlength="1">
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        <label for="input01" class="col-sm-2 control-label">镜像类型*</label>
                        <div class="col-sm-4"> 
                            <div class="col-sm-16" ><select class="chosen-select chosen-transparent form-control" id="input08" >
                            <option>从主机创建</option>
                           </select></div> 
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-4" id="selectbox">
                          <select class="chosen-select chosen-transparent form-control" name="fromHostId"id="fromHostId" parsley-trigger="change" parsley-required="true" parsley-error-container="#selectbox">
