          ...
          <div class="main">
            ...
            <div class="row">
              ...
              <div class="col-md-10">
                ...
                <!-- tile -->
                <section class="tile color transparent-black" style="width:1075px;height: 160px;">
                  <!-- tile header -->
                  <div class="tile-header">
                    
                    <h1><a href="javascript:history.go(-1)"    style="color:#FAFAFA;cursor:pointer;padding-right:10px;"> <i class="fa fa-reply"></i></a> 主机信息</h1>
                    <div class="controls">
