              ...
              <div class="col-md-12">
                ...
                <section class="tile color transparent-black">
                  ...
                  <div class="tile-body">
                    ...
                    <form class="form-horizontal" role="form" parsley-validate id="basicvalidations" action="<%=request.getContextPath() %>/tenant/host/update" method="post"   >
		        						...
		        						if(data.status == "fail"){
		        							 isCommited = false;
							        		  $("#tipscontent").html(data.message);
	   		        						...
	   		        						window.location.href = path + "/tenant/${tenantId}/host";
		        						}
		        					},
		        					dataType:'json',
		        					timeout:10000
