				  ...
				  <section class="tile color transparent-black" style="height:470px;">
	                  ...
	                  <div class="tile-widget color transparent-black rounded-top-corners nopadding nobg">
	                    ...
	                    <ul class="nav nav-tabs tabdrop">
	                      ...
	                      <li class="active"><a href="#messages-tab" onclick="window.location.href='<%=request.getContextPath() %>/backresume/desktopbackuptimer/manage';" data-toggle="tab">定时备份主机管理</a></li>
