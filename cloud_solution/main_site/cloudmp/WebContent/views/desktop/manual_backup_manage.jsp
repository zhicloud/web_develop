				...
				<!-- tile widget -->
                  <div class="tile-widget color transparent-black rounded-top-corners nopadding nobg">
                    ...
                    <ul class="nav nav-tabs tabdrop">
                      ...
                      <li class="active"><a href="#tasks-tab" data-toggle="tab" onclick="window.location.href='<%=request.getContextPath() %>/backresume/manualbackup';">手动备份</a></li>
                      <div id="space"></div>
                  ...
                  <div class="tile-body">
                    ...
                    <form class="form-horizontal" role="form" parsley-validate id="basicvalidations" action="<%=request.getContextPath() %>/backresume/manualbackup" method="post"   >
   		        					...
   		        					success:function result(data){
   		        						if(data.status == "fail"){
							        		  ...
							        		  $("#tipscontent").html("创建失败");
	   		        						...
	   		        						window.location.href=path+"/backresume/detailmanage";
   		        						}
   		        					},
   		        					dataType:'json',
   		        					timeout:10000
