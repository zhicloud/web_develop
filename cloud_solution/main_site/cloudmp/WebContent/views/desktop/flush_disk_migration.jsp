...
<!-- flush_disk_manage.jsp -->
 <html>
  ...
  <body class="bg-1">
      ...
      <div class="row">
        ...
        <div id="content" class="col-md-12">
          ...
          <div class="pageheader">
            ...
            <h2><i class="fa fa-server"></i> ${host.displayName}主机迁移</h2>
              ...
              <div class="col-md-12">
                ...
                <section class="tile color transparent-black">
                  ...
                  <div class="tile-body">
					...
					<input id="realHostId" type="hidden" value="${realHostId}"/>
    ...
    $(function(){
    	$("#tips").html("正在迁移。。。")
    	//setInterval(refreshFlushProgress, 5000);
    	refreshFlushProgress();
    }); 
     
function refreshFlushProgress(){
	jQuery.ajax({
		url: path+'/cdrpm/cloudserver/getflushprogress',
		type: 'get',
		data: 'uuid=' + uuid,
		dataType: 'json', 
		async: false,
		...
		success: function(result)
		{
			 if(result.status == "success")
				...
				}else if(result.properties.migrate_true==null ){
					window.setTimeout(self.refreshFlushProgress, 5000);
				}else if(result.properties.migrate_true==false ){
					$("#tipscontent").html("迁移失败");
	     		    $("#dia").click();
				}else{
				// 云主机尚未开始重装，继续获取信息
				window.setTimeout(self.refreshPage, 5000);
			}
		}
	}); 
}
