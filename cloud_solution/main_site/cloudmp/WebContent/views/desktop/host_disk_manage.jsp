      ...
      <div class="row">
        ...
        <div id="content" class="col-md-12">
          ...
          <div class="pageheader">
            ...
            <h2><i class="fa fa-database"></i> 云桌面主机磁盘管理</h2>
...
<!--               <i class="fa fa-search"></i> <input id="search_input" type="text" placeholder="资源节点名称"> -->
					 ...
					 <div class="modal fade" id="modalForm" tabindex="-1" role="dialog" aria-labelledby="modalConfirmLabel" aria-hidden="true"  >
                      <div class="modal-dialog">
                        <div class="modal-content" style="width:60%;margin-left:20%;">
                          ...
                          <div class="modal-body">
                            <form class="form-horizontal" id="addAmountForm" role="form" action="<%=request.getContextPath() %>/addAmount" method="post">
    ...
    $(function(){
    	...
    	$("#add_data_disk").click(function(){
    		window.location.href = path+"/cloudhost/"+realId+"/"+diskType+"/addDataDisk";
    	});
    	//删除资源节点
    ...
    function deleteDataDisk(){
    	jQuery.ajax({
	        url: '<%=request.getContextPath()%>/cloudhost/ddd',
	        type: 'post', 
	        dataType: 'json',
