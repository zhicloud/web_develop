                ...
                <section class="tile color transparent-black">
                  ...
                  <div class="tile-body">
                    ...
                    <p class="filled greensea"> 
                      1.由于可能存在文件锁定的情况，我们不承诺100%成功，若有非常重要的数据，请您自己备份。<br><br>
                    ...
                    <div class="modal fade" id="backup" tabindex="-1" role="dialog" aria-labelledby="modalConfirmLabel" aria-hidden="true">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form class="form-horizontal" role="form"  id="basicvalidations_password" action="<%=request.getContextPath() %>/warehouse/cloudhost/addbackup" method="post"   >
...
function refreshBackupProgress(){
	...
	jQuery.ajax({
		url: path+'/warehouse/cloudhost/getbackupprogress',
		type: 'get',
...
function cloud_host_resume() {
	jQuery.ajax({
		url: path+'/warehouse/cloudhost/resumhost',
		type: 'post',
...
function queryBackup() { 
	jQuery.ajax({
        url: path+'/warehouse/cloudhost/querybackinfo',
        type: 'post', 
        data:"id="+'${host.id}',
        dataType: 'json',
        timeout: 10000,
...
function refreshResumeProgress(){
	jQuery.ajax({
		url: path+'/warehouse/cloudhost/getresumprogress',
		type: 'get',
		data: 'uuid=' + '${host.realHostId}',
		dataType: 'json', 
		async: false,
