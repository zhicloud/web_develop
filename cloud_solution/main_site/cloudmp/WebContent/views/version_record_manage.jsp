...
<html>
  ...
  <body class="bg-1">
        ...
        <div id="content" class="col-md-12">
          ...
          <div class="col-md-12">
                  ...
                  <div class="tile-header">
                    ...
                    <button type="button" class="btn btn-green file-excel-o" onclick="exportData('/export/versiondata')">
                      ...
                      <table  class="table table-datatable table-custom table-sortable" id="basicDataTable">
                        ...
                        <tbody>
                          <c:forEach items="${versionList}" var="version">
                    		...
                    		<td>
								<div class="checkbox check-transparent">
								  <input type="checkbox" value="${version.id}" name="checkboxid" id="chck${version.id}" >
								  <label for="chck${version.id}"></label>
								</div>
                                </td>
                            ...
                            <td class="center">
                            <c:if test="${version.createTimeDate == null}">
                            &nbsp;                                                                        
                            </c:if>
                            <fmt:formatDate value="${version.createTimeDate}" pattern="yyyy-MM-dd HH:mm:ss"/>
                            </td> 
                            <td >
                             <button type="button" class="btn btn-primary btn-xs" onclick="deleteType('${version.id }');">删除</button> 
                             </td>
                        </tr>
                    	</c:forEach>
                          ...
                          <div class="modal-body">
                            <form role="form">   
                              ...
                              <div class="form-group">
                                <label style="align:center;" id="confirmcontent">确定要删除该版本吗？</label>
                               </div>
    ...
    function toDelete(){
    	jQuery.get(path + "/version/"+operid+"/delete",function(data){
    ...
    function addType(){          					
	      location.href = path+"/version/addpage";  
