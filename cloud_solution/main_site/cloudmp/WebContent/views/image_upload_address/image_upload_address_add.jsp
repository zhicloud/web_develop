    ...
    <div class="row">
        ...
        <div id="content" class="col-md-12">
            ...
            <div class="pageheader">
                ...
                <h2><i class="fa fa-inbox"></i> 新增上传地址</h2>
...
<script>
    ...
    $(function(){
        ...
        $('#service_name').change(function(){
            var localIp = $(this).children('option:selected').attr("localIp");
            var localPort = $(this).children('option:selected').attr("localPort");
