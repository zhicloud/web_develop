...
.menusTopCss{
    ...
    overflow-y: auto;
    z-index: -2;
    background-color: rgba(17, 127, 210, 1.0);
}
-->
</style>
<script>
      ...
      <div class="row">
        ...
        <div class="navbar navbar-default navbar-fixed-top navbar-transparent-black mm-fixed-top" role="navigation" id="navbar">
			...
			<div class="navbar-collapse">
				<!-- Page refresh -->
				<ul id="menusId" class="refresh menusTopCss"><li class="divided"><a href="#" class="page-refresh"><i class="fa fa-refresh"></i></a></li></ul>
				<!-- /Page refresh -->
