      ...
      <div class="row">
        ...
        <div id="content" class="col-md-12">
          ...
          <div class="pageheader">
            ...
            <h2><i class="fa fa-user-md"></i> 修改用户</h2>
              ...
              <div class="col-md-12">
                ...
                <section class="tile color transparent-black">
                  ...
                  <div class="tile-body">
                    ...
                    <form class="form-horizontal" role="form" parsley-validate id="basicvalidations" action="<%=request.getContextPath() %>/user/${user.id}/update" method="post"   >
                      ...
                      <%--<div class="form-group">--%>
                        ...
                        <%--<div class="col-sm-4">--%>
                          <%--<input type="text" class="form-control" id="alias" name="alias" oldname="${user.alias}" value="${user.alias}"  parsley-trigger="change" parsley-type="nochinese" parsley-required="true" parsley-minlength="4" parsley-checkalias="true" parsley-maxlength="50" parsley-validation-minlength="4">--%>
                        <%--</div>--%>
                      <%--</div>--%>
                      <div class="form-group">
                        <label for="name" class="col-sm-2 control-label">显示名*</label>
                        <div class="col-sm-4">
                          <input type="text" class="form-control" id="name" name="name"  value="${user.name}"   parsley-trigger="change" parsley-required="true"  parsley-minlength="2" parsley-maxlength="50" parsley-validation-minlength="1">
                        </div>
                      </div> 
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-sm-4" id="selectbox">
                          <select class="chosen-select chosen-transparent form-control" id = "group_id" name="groupId">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-4">
                          <input type="email" class="form-control" id="email" name="email" value="${user.email}" parsley-trigger="change"    parsley-type="email"  >
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="phone" class="col-sm-2 control-label">电话*</label>
                        <div class="col-sm-4">
                          <input type="text" class="form-control" id="phone" name="phone" value="${user.phone}" parsley-trigger="change"  parsley-type="phone"   >
                        </div>
                      </div> 
