      ...
      <div class="row">
        ...
        <div id="content" class="col-md-12">
          ...
          <div class="pageheader">
            ...
            <h2><i class="fa fa-database"></i>消息推送管理</h2>
                  ...
                  <div class="tile-body">
                    ...
                    <form class="form-horizontal" role="form" parsley-validate id="basicvalidations" action="<%=request.getContextPath() %>/terminalinfo/add" method="post"   >
                       <div class="form-group">
                        ...
                        <div class="col-sm-4" id="selectbox">
                          <select class="chosen-select chosen-transparent form-control" name="groupId" id="input07" parsley-trigger="change" parsley-required="true" parsley-error-container="#selectbox">
                            ...
                            <c:forEach items="${groupList }" var="sdi">
                                <option value="${sdi.id }">${sdi.groupName }</option>
                              </c:forEach>  
                          </select>
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-sm-4">
                          <input type="text" class="form-control" id="title" name="title"  parsley-trigger="change" parsley-required="true"     parsley-maxlength="50">
                        </div>
                      </div>
    				  <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-4">
                          <textarea class="form-control" parsley-trigger="change" parsley-required="true"     parsley-maxlength="500" id="content" name="content" rows="6"></textarea>
                        </div>
                      </div>
