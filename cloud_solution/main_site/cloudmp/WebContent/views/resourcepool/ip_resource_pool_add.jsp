...
<!DOCTYPE html>
 <html>
  ...
  <body class="bg-1">
              ...
              <div class="col-md-12">
                ...
                <section class="tile color transparent-black">
                  ...
                  <div class="tile-header">
                    <h3><a href="<%=request.getContextPath() %>/ipresourcepool/all"    style="color:#FAFAFA;cursor:pointer;padding-right:10px;"> <i class="fa fa-reply"></i></a>输入IP资源池信息</h3>
                    <div class="controls">
                  ...
                  <div class="tile-body">
                    ...
                    <form class="form-horizontal" role="form" parsley-validate id="basicvalidations" action="<%=request.getContextPath() %>/ipresourcepool/add" method="post"   >
    ...
    //返回
    function backhome(){
   		window.location.href = "<%=request.getContextPath()%>/ipresourcepool/all";
    }   
