...
<!DOCTYPE html>
<!-- server_resource_pool_node_device.jsp -->
<html>
  <head>
              ...
              <div class="col-md-12">
                  ...
                  <div class="tile-header">
                     ...
                     <button type="button" class="btn btn-success delete" 
                          <c:if test="${formPageFlag==0}">onclick="window.location.href='<%=request.getContextPath()%>/csrpm/${poolId}/rd';"</c:if>
...
<!--             		</div> -->
                        ...
                        <div class="modal-content" style="width:80%;margin-left:10%;">
                          ...
                          <div class="modal-body">
                            <form class="form-horizontal" id="addShareDiskForm" role="form"  method="post"
                                    <c:if test="${formPageFlag==0}"> action="<%=request.getContextPath() %>/csrpm/addShareDisk"</c:if>
    ...
    <script>
	    ...
	    function unmountDiskServer(){
	    	...
	    	jQuery.ajax({
		        url: '<%=request.getContextPath()%>/csrpm/unmount',
		        type: 'post', 
		        dataType: 'json',
	    ...
	    function mountDiskServer(){
	    	jQuery.ajax({
		        url: '<%=request.getContextPath()%>/csrpm/mount',
		        type: 'post', 
		        dataType: 'json',
		        data:{'nodename':nodename,'index':index,'disk_type':disk_type},
		        timeout: 10000,
	    ...
	    function enableDiskServer(){
	    	jQuery.ajax({
		        url: '<%=request.getContextPath()%>/csrpm/enableDisk',
		        type: 'post', 
		        dataType: 'json',
	    ...
	    function disableDiskServer(){
	    	jQuery.ajax({
		        url: '<%=request.getContextPath()%>/csrpm/disableDisk',
		        type: 'post', 
		        dataType: 'json',
		        data:{'nodename':nodename,'index':index},
		        timeout: 10000,
