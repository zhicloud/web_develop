      ...
      <div class="row">
        ...
        <div id="content" class="col-md-12">
          ...
          <div class="pageheader">
            ...
            <h2><i class="fa fa-calculator"></i> 计算资源池管理</h2>
...
<!--               <i class="fa fa-search"></i> <input type="text" placeholder="资源池名称"> -->
    ...
    $(function(){
    	jQuery(".query_detail").click(function(){
	    	...
	    	window.location.href = path+"/computeresourcepool/"+uuid+"/nc";
	    });	
    	...
    	jQuery(".query_host_detail").click(function(){
	    	...
	    	window.location.href = path+"/computeresourcepool/"+uuid+"/"+name+"/hpdetail";
	    });
    });
   	</script>
