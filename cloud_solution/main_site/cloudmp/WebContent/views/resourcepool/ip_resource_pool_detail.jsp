            ...
            <div class="row">
              ...
              <div class="col-md-12">
                  ...
                  <div class="tile-header">
                     <a href="<%=request.getContextPath()%>/ipresourcepool/all"    style="color:#FAFAFA;cursor:pointer;padding-right:10px;"> <i class="fa fa-reply"></i></a>
    ...
    <script>
	    ...
	    $(function(){
	    	...
	    	$("#create_resource_node").click(function(){
	    		window.location.href ="<%=request.getContextPath()%>/ipresourcepool/"+poolId+"/an";
	    	});
	    	//删除资源节点
	    ...
	    function deleteResourceNode(){
		   	jQuery.ajax({
		        url: '<%=request.getContextPath()%>/ipresourcepool/dn',
		        type: 'post', 
		        dataType: 'json',
