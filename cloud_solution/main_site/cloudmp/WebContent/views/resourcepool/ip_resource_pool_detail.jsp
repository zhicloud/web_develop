      ...
      <div class="row">
        ...
        <div id="content" class="col-md-12">
          ...
          <div class="pageheader">
            ...
            <h2><i class="fa fa-life-buoy"></i> 地址资源管理</h2>
            ...
            <div class="row">
              ...
              <div class="col-md-12">
                  ...
                  <div class="tile-header">
                     <a href="<%=request.getContextPath()%>/networkpool/ipresourcepool/all"    style="color:#FAFAFA;cursor:pointer;padding-right:10px;"> <i class="fa fa-reply"></i></a>
                     <button type="button" class="btn btn-success delete" id="create_resource_node">
                              <i class="fa fa-plus"></i>
                              <span> 新增地址资源 </span>
                            </button>
<!--              <div class="search  text-left" id="main-search">-->
<!--              <i class="fa fa-search"></i> <input id="search_input" type="text" placeholder="IP资源节点名称">-->
<!--            </div>-->
<!--            -->
            		<div class="controls">
                  ...
                  <div class="row">
				  <c:forEach items="${ipPoolDetailList}" varStatus="i" var="cp">
						<div class="col-lg-3 col-md-3" style="width:330px;">
                       
                        
                        <div class="panel panel-greensea">
                          <div class="panel-heading title">
                            <h3 class="panel-title">地址资源${i.count}</h3>
                          </div>
...
<!--                       	<li><a href="#">新增资源节点</a></li> -->
                        <li><a href="javascript:void(0);" cur_ip="${cp.ip}" class="delete_resource_node">删除该地址资源节点</a></li>
	                         ...
	                         <div class="modal-body">
	                           <form role="form">   
	                             ...
	                             <div class="form-group">
	                               <label style="align:center;" id="confirmcontent">确定要删除该地址资源吗？</label>
	                              </div>
    ...
    <script>
	    ...
	    $(function(){
	    	...
	    	$("#create_resource_node").click(function(){
	    		window.location.href ="<%=request.getContextPath()%>/networkpool/ipresourcepool/"+poolId+"/an";
	    	});
	    	//删除资源节点
		    $(".delete_resource_node").click(function(){
		    	var ip = $(this).attr("cur_ip");
		    	cur_ip = ip;
		    	$("#confirmcontent").html("确定要删除地址资源资源节点吗？");
	    ...
	    function deleteResourceNode(){
		   	jQuery.ajax({
		        url: '<%=request.getContextPath()%>/networkpool/ipresourcepool/dn',
		        type: 'post', 
		        dataType: 'json',
