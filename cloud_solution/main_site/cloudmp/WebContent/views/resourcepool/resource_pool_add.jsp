                  ...
                  <div class="tile-body">
                    ...
                    <form class="form-horizontal" role="form" parsley-validate id="basicvalidations" action="<%=request.getContextPath() %>/cdrpm/add" method="post"   >
                      ...
                      <div class="form-group" id="ip_pool">
                        ...
                        <div class="col-sm-4" id="selectbo_ip">
                      ...
                      <div class="form-group" id="port_pool">
                        ...
                        <div class="col-sm-4" id="selectbox_port">
                          <select class="chosen-select chosen-transparent form-control" name="networkId" id="input007" parsley-trigger="change" parsley-required="true" parsley-error-container="#selectbox_port" >
                            <option value="">请选择资源池</option> 
