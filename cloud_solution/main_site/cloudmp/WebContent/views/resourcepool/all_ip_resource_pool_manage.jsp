...
<!DOCTYPE html>
<!-- all_ip_resource_pool_manage.jsp -->
<html>
	<head>
	...
	<script type="text/javascript">
		...
		$(function(){
	    	$(".query_detail").click(function(){
		    	...
		    	window.location.href = "<%=request.getContextPath()%>/networkpool/ipresourcepool/"+uuid+"/qn?poolname="+poolname;
		    });	
		...
		function loadAddPage(){
			window.location.href ="<%=request.getContextPath()%>/networkpool/ipresourcepool/add";
		}
		
	    function toDelete(){
	    	jQuery.ajax({
	        url: '<%=request.getContextPath()%>/networkpool/ipresourcepool/rm',
	        type: 'post', 
	        dataType: 'json',
	        data:{uuid:uuid},
	        timeout: 10000,
