      ...
      <div class="row">
        ...
        <div id="content" class="col-md-12">
          ...
          <div class="pageheader">
            ...
            <h2><i class="fa fa-life-buoy"></i> 资源池节点管理</h2>
...
<%--                            <p><strong>云主机数量：</strong><a href="#"><span class="badge badge-greensea">${cp.getAllHost()}</span></a>台</p> --%>
                    ...
                    <div class="progress-list">
                      ...
                      <ul class="dropdown-menu" role="menu">
						...
						<li><a href="javascript:void(0);" cur_name="${cp.name }" class="mount_disk_node">磁盘挂载</a></li>                        
                      </ul>
                    </div>
    ...
    $(function(){
    	...
    	$("#search_input").blur(function(){
    		...
    		if(value=='' || value==undefined){
    			window.location.href = path+"/computeresourcepool/"+poolId+"/nc";
    		}else{
    			window.location.href = path+"/computeresourcepool/"+poolId+"/nc?sn="+value;
    		}
    	});
    	...
    	$("#create_resource_node").click(function(){
    		...
    		window.location.href = path+"/computeresourcepool/"+poolId+"/an";
    	});
    	
    	 
    	//查看资源节点磁盘挂载 
	    jQuery(".mount_disk_node").click(function(){
	    	var name = jQuery(this).attr("cur_name");
	    	window.location.href = path+"/computeresourcepool/"+name+"/device?poolId="+poolId;
	    });
    ...
    function deleteResourceNode(){
    	jQuery.ajax({
	        url: '<%=request.getContextPath()%>/computeresourcepool/dn',
	        type: 'post', 
	        dataType: 'json',
