                  ...
                  <div class="tile-body">
                    ...
                    <form class="form-horizontal" role="form" parsley-validate id="basicvalidations" action="${pageContext.request.contextPath }/cdrpm/mod" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="optionsRadios0" class="col-sm-2 control-label">网络类型 *</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group">
                            <label for="optionsRadios2" class="col-sm-2 control-label"></label>
                            <div class="col-sm-10">
					...
					<div class="form-group">
					    ...
					    <div class="col-sm-8">
					        <div class="radio radio-transparent col-md-2">
					        	<input type="radio" name="diskType" id="optionsRadios10" value="0" onclick="$('#divNas').removeAttr('show');$('#divNas').attr('class','hidden');$('#path').removeAttr('parsley-required');" checked>
