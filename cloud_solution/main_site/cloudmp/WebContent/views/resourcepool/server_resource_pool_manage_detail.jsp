...
<!DOCTYPE html>
<!-- server_resource_pool_manage_detail.jsp -->
<html>
  <head>
...
<%--                            <p><strong>云主机数量：</strong><a href="#"><span class="badge badge-greensea">${cp.getAllHost()}</span></a>台</p> --%>
    ...
    $(function(){
    	...
    	$("#search_input").blur(function(){
    		...
    		if(value=='' || value==undefined){
    			window.location.href = path+"/csrpm/"+poolId+"/rd";
    		}else{
    			window.location.href = path+"/csrpm/"+poolId+"/rd?sn="+value;
    		}
    	});
    	...
    	$("#create_resource_node").click(function(){
    		...
    		window.location.href = path+"/csrpm/"+poolId+"/an";
    	});
      ...
      function deleteResourceNode(){
    	jQuery.ajax({
	        url: '<%=request.getContextPath()%>/csrpm/dn',
	        type: 'post', 
	        dataType: 'json',
    ...
    function mountDevciceclick(a){
    	...
    	window.location.href = path+"/csrpm/"+name+"/device?poolId="+poolId;
    }
