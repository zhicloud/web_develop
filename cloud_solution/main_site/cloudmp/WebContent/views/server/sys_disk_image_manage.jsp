      ...
      <div class="row">
        ...
        <div id="content" class="col-md-12">
          ...
          <div class="pageheader">
            ...
            <h2><i class="fa fa-hdd-o"></i> 云服务器镜像管理</h2>
          ...
          <div class="col-md-12">
                  ...
                  <div class="tile-header"> 
                    ...
                    <button type="button" class="btn btn-green file-excel-o" onclick="exportData('/export/serverimagedata')">
                    ...
                    <div class="modal fade" id="modalimagetype" tabindex="-1" role="dialog" aria-labelledby="modalConfirmLabel" aria-hidden="true">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form class="form-horizontal" role="form" parsley-validate id="basicvalidations_imagetype" action="<%=request.getContextPath() %>/serverimage/change/imagetype" method="post"   >
...
<!--                             <button class="btn btn-green" onclick="uploadAfter()"   data-dismiss="modal" aria-hidden="true">确定</button>
 -->                            <button class="btn btn-red"   onclick="uploadAfter()" data-dismiss="modal" aria-hidden="true">关闭</button>
  ...
  <iframe id="uploadFrame"  style="width:0; height:0; margin-top:-10px;" name="uploadFrame"></iframe>
    ...
    function toDelete(){
    	jQuery.get(path + "/serverimage/"+operid+"/delete",function(data){
        ...
        success: function(result)
        {
        	if(result.status == "fail"){
        		   ...
        		   $("#dia").click();
	        		...
	        		location.href = path + "/serverimage/"+id+"/update";  
    ...
    function addImage(){          					
	      location.href = path+"/serverimage/add";  
