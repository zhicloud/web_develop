...
<!DOCTYPE html>
<!-- back_up_host_detail_manage.jsp -->
<html>
  <head>
          ...
          <div class="col-md-12">
                  ...
                  <div class="tile-widget color transparent-black rounded-top-corners nopadding nobg">
                    ...
                    <ul class="nav nav-tabs tabdrop">
                      <li class="active"><a href="#users-tab" data-toggle="tab" onclick="window.location.href='<%=request.getContextPath() %>/csbackresume/detailmanage';">备份记录</a></li>
                  ...
                  <!-- tile header -->
                      <div class="tile-header">  
	                    <button type="button" class="btn btn-green file-excel-o" onclick="exportData('/export/csbackresumedata')">
	        	...
	        	if(result.status == "fail"){ 
	        		  $("#tipscontent").html("登录超时，请重新登录");
	     		      $("#dia").click();
		        		...
		        		jQuery.get(path + "/serverbackresume/"+id+"/"+mode+"/"+disk+"/resume",function(data){
