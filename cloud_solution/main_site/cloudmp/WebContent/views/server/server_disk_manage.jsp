            ...
            <div class="row">
              ...
              <div class="col-md-12">
                  ...
                  <div class="tile-header" id="new_data_disk">
                     <button type="button" class="btn btn-success delete" onclick="window.location.href='<%=request.getContextPath()%>/cloudserver/all';">
...
<!--               <i class="fa fa-search"></i> <input id="search_input" type="text" placeholder="资源节点名称"> -->
    ...
    function deleteDataDisk(){
    	jQuery.ajax({
	        url: '<%=request.getContextPath()%>/cloudserver/ddd',
	        type: 'post', 
	        dataType: 'json',
