          ...
          <div class="col-md-12">
                  ...
                  <!-- /tile header -->
                    ...
                    <div class="tile-header">
                         <button type="button" class="btn btn-success delete" onclick="window.location.href='<%=request.getContextPath()%>/csrpm/all';">
...
// 		        })
    ...
    function startHost(){
    	jQuery.get(path + "/csrpm/"+currentId+"/start",function(data){
			if(data.status == "success"){   
	    		window.location.reload();
			}else{  
				$("#tipscontent").html(data.message);
    ...
    function restartHost(){
    	jQuery.get(path + "/csrpm/"+currentId+"/restart",function(data){
			if(data.status == "success"){   
	    		window.location.reload();
			}else{  
				$("#tipscontent").html(data.message);
    ...
    function shutdownHost(){
    	jQuery.get(path + "/csrpm/"+currentId+"/stop",function(data){
			if(data.status == "success"){   
	    		window.location.reload();
			}else{  
				$("#tipscontent").html(data.message);
    ...
    function haltHost(){
    	jQuery.get(path + "/csrpm/"+currentId+"/halt",function(data){
			if(data.status == "success"){   
	    		window.location.reload();
			}else{  
				$("#tipscontent").html(data.message);
    ...
    function addServer(){
    	jQuery.get(path + "/csrpm/"+currentId+"/addserver",function(data){
			if(data.status == "success"){   
	    		window.location.reload();
			}else{  
				$("#tipscontent").html(data.message);
    ...
    function addDesktop(){
		...
		if(form.parsley('isValid')){  		        				
	    	...
	    	jQuery.get(path + "/csrpm/"+currentId+"/"+wareHostId+"/adddesktop",function(data){
				if(data.status == "success"){   
		    		window.location.reload();
				}else{  
					$("#tipscontent").html(data.message);
