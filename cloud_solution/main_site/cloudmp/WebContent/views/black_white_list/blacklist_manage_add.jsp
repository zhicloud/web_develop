      ...
      <div class="row">
        ...
        <div id="content" class="col-md-12">
          ...
          <div class="pageheader">
            ...
            <h2><i class="fa fa-file-text"></i>添加黑名单</h2>
                ...
                <section class="tile color transparent-black">
                 ...
                 <!-- tile widget -->
                  ...
                  <div class="tile-body">
                    ...
                    <form class="form-horizontal" role="form" parsley-validate id="basicvalidations" action="<%=request.getContextPath() %>/networkrule/blacklist/add" method="post"   >
                      
                      <div class="form-group">
                        <label for="input01" class="col-sm-2 control-label">规则名 *</label>
                        <div class="col-sm-4">
                          <input type="text" class="form-control" id="ruleName" name="ruleName"  parsley-trigger="change" parsley-required="true" parsley-checkblacklistname="true" parsley-minlength="2" parsley-maxlength="50" parsley-validation-minlength="1">
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="input01" class="col-sm-2 control-label">IP *</label>
                        <div class="col-sm-4">
                          <input type="text" class="form-control" id="ruleIp" name="ruleIp"  parsley-trigger="change" parsley-required="true" parsley-checkip="true" parsley-minlength="2" parsley-maxlength="50" parsley-validation-minlength="1">
                        </div>
                      </div>
                     <div class="form-group">
