...
function serverquery(){	 
	window.location.href = "<%=request.getContextPath()%>/monitor/resourcequery";
}
//更新屏蔽状态
...
function statusquery(val){
	...
	window.location.href = "<%=request.getContextPath() %>/monitor/resourcetohost?data="+JSON.stringify(data);
}
</script>
    <!-- Make page fluid -->
    <div class="row">
