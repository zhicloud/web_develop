      ...
      <div class="row">
        ...
        <div id="content" class="col-md-12">
          ...
          <div class="pageheader">
            ...
            <h2><i class="fa fa-cogs"></i> 修改服务器配置</h2>
              ...
              <div class="col-md-12">
                ...
                <section class="tile color transparent-black">
                  ...
                  <div class="tile-body">
                    ...
                    <form class="form-horizontal" role="form" parsley-validate id="basicvalidations" action="<%=request.getContextPath() %>/cscm/${chcm.id }/updateserver" method="post"   >
...
<%--                            <option value="1" <c:if test="${chcm.supportH264==1 }">selected</c:if>>局部H.264编码</option>    --%>
    ...
    $(function(){
        ...
        if('${chcm.sysImageId}'==null || $('chcm.sysImangeId')==''){
        	$('#empty_system').attr("checked","checked");
        	str = '${chcm.sysDiskText}';
        }else{
        	$('#create_from_img').attr("checked","checked");
        	$('#sysImageId').val('${chcm.sysImageId}');
        }
      //chosen select input
 		        					...
 		        					success:function result(data){
 		        						if(data.status == "fail"){
							        		  ...
							        		  $("#tipscontent").html(data.message);
	   		        						...
	   		        						location.href = path + "/cscm/allserver";
