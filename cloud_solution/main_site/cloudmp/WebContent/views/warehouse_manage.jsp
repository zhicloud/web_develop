                        ...
                        <c:forEach items="${cloudHostWarehouseList}" var="chw">
                          ...
                          <tr class="odd gradeX">
                                  ...
                                  <td class="cut">
		                            ...
		                            &nbsp;<a hrep="javascript:void(0);" onclick="toDetail('${chw.id }');" style="color:#FAFAFA;cursor:pointer">${chw.name}</a>
                                  </td>
                                  <td class="cut">
                    ...
                    <div class="modal fade" id="modalForm" tabindex="-1" role="dialog" aria-labelledby="modalConfirmLabel" aria-hidden="true"  >
                      <div class="modal-dialog">
                        <div class="modal-content" style="width:60%;margin-left:20%;">
                          ...
                          <div class="modal-footer">
                            <input type="button" class="btn btn-green"  id="form_btn" onclick="saveAddAmount();" value="确认">
