    ...
    <div class="row">
        ...
        <div id="content" class="col-md-12">
            ...
            <div class="pageheader">
                ...
                <h2><i class="fa fa-inbox"></i> 新增短信配置</h2>
                    ...
                    <div class="col-md-12">
                        ...
                        <section class="tile color transparent-black">
                            ...
                            <div class="tile-body">
                                ...
                                <form class="form-horizontal" id="sms_config_form" role="form" action="${pageContext.request.contextPath }/message/sms/config/add" method="post">
                                    <div class="form-group">
                                        <label for="config_name" class="col-sm-2 control-label" >短信配置名称*</label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" id="config_name" name="configName" value="" parsley-trigger="change" parsley-required="true" parsley-minlength="5" parsley-maxlength="50" parsley-checksmsconfigname="true">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" id="name" name="name" parsley-trigger="change" parsley-required="true" parsley-type="nochinese">
                                        </div>
                                    </div>
