    ...
    <div class="row">
        ...
        <div id="content" class="col-md-12">
            ...
            <div class="pageheader">
                ...
                <h2><i class="fa fa-inbox"></i> 新增短信模板</h2>
                    ...
                    <div class="col-md-12">
                        ...
                        <section class="tile color transparent-black">
                            ...
                            <div class="tile-body">
                                ...
                                <form class="form-horizontal" id="sms_template_form" role="form" action="${pageContext.request.contextPath }/message/sms/template/add" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" id="name" name="name" value="" parsley-trigger="change" parsley-required="true" parsley-minlength="5" parsley-maxlength="50" parsley-checksmstemplatename="true">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" id="code" name="code" value="" parsley-trigger="change" parsley-required="true" parsley-type="nochinese" parsley-minlength="2" parsley-maxlength="50" parsley-checksmstemplatecode="true">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <textarea rows="6" id="sms_content" name="content" style="width: 315px;" parsley-trigger="change" parsley-required="true" parsley-minlength="2" parsley-maxlength="50" parsley-validation-minlength="1"></textarea>
                                        </div>
                                    </div>
