                            ...
                            <div class="tile-body">
                                ...
                                <form class="form-horizontal" id="sms_template_form" role="form" action="${pageContext.request.contextPath }/message/sms/template/add" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" id="code" name="code" value="" parsley-trigger="change" parsley-required="true" parsley-minlength="2" parsley-maxlength="50" parsley-checksmstemplatecode="true">
                                        </div>
                                    </div>
