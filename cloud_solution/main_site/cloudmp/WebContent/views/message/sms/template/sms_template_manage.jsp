                    ...
                    <div class="col-md-12">
                        ...
                        <section class="tile color transparent-black">
                            ...
                            <ul class="nav nav-tabs tabdrop">
                                ...
                                <li class="active"><a href="#" data-toggle="tab" onclick="redirect('/message/sms/template/list');">短信模板管理</a></li>
                            ...
                            <div class="tile-header">
			                    ...
			                    <button type="button" class="btn btn-green file-excel-o" onclick="exportData('/export/smstemplatelistdata')">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table  class="table table-datatable table-custom table-sortable" id="basicDataTable">
                                        ...
                                        <tr>
                                            ...
                                            <th class="sortable sort-amount">短信模板名称</th>
                                            <th class="sortable sort-amount">短信服务器</th>
                                            <th class="sortable sort-amount">收信人号码</th>
                                        ...
                                        <tbody>
                                        <c:forEach items="${sms_template_list}" var="sms_templates">
                                            <tr class="gradeX">
                                                <td>
                                                    <div class="checkbox check-transparent">
                                                        <input type="checkbox" value="${sms_templates.id}" name="checkboxid" id="chck${sms_templates.id}" >
                                                        <label for="chck${sms_templates.id}"></label>
                                                    </div>
                                                </td>
                                                <td class="cut"><a hrep="javascript:void(0);" onclick="mod_template('${sms_templates.id }');" style="color:#FAFAFA;cursor:pointer">${sms_templates.name}</a></td>
                                                <td class="cut">${sms_templates.configName}</td>
                                                <td class="cut">${sms_templates.recipient}</td>
                                                <td class="cut">${sms_templates.code}</td>
                                                <td class="cut"><fmt:formatDate
                                                        value="${sms_templates.createTimeDate}"
                                                        pattern="yyyy-MM-dd HH:mm:ss"/></td>
                                                <td class="cut"><fmt:formatDate
                                                        value="${sms_templates.modifiedTimeDate}"
                                                        pattern="yyyy-MM-dd HH:mm:ss"/></td>
                                                <td>
                                                    <div class="btn-group">
                                                        <button type="button"
                                                        ...
                                                        <ul class="dropdown-menu" role="menu">
                                                            <li><a href="#" onclick="mod_template('${sms_templates.id }');">修改</a></li>
                                                            <li class="divider"></li>
                                                            <li><a href="#" onclick="del_template('${sms_templates.id }');">删除</a></li>
                                                        </ul>
                                                    </div>
                                                </td>
                                            </tr>
                                            ...
                                            <div class="modal-body">
                                                <form role="form">
                                                    ...
                                                    <div class="form-group">
                                                        <label style="align:center;" id="confirmcontent">确定要删除该短信模板吗？</label>
                                                    </div>
...
<script>
    ...
    $(function(){
        ...
        $("#templateAdd").click(function(){
            window.location.href = "${pageContext.request.contextPath}/message/sms/template/add";
        });
        ...
        jQuery("#submit_oper").click(function(){
            ...
            if(option=="delete"){
                ...
                if(myids.length < 1){
                    $("#tipscontent").html("请选择要删除的短信模板");
                    $("#dia").click();
                    return;
                }
                ids = myids;
                $("#confirmcontent").html("确定要删除所选短信模板吗？");
    ...
    function mod_template(id) {
        window.location.href = "${pageContext.request.contextPath}/message/sms/template/"+id+"/mod";
    }

    function del_template(id) {
        $("#confirmcontent").html("确定要删除该短信模板吗？");
        curId = id;
    ...
    function deleteEmailConfig(){
        jQuery.get("${pageContext.request.contextPath}/message/sms/template/"+curId+"/remove",
                function(data){
                    if(data.status=="success"){
                        location.href = "${pageContext.request.contextPath}/message/sms/template/list";
                    }else{
    ...
    function deleteMultEmailConfig(){
        jQuery.ajax({
            url: '<%=request.getContextPath()%>/message/sms/template/remove',
            type: 'post',
            dataType: 'json',
            data:{ids:ids},
            async: false,
