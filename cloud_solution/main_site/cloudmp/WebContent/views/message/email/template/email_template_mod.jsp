    ...
    <div class="row">
        ...
        <div id="content" class="col-md-12">
            ...
            <div class="pageheader">
                ...
                <h2><i class="fa fa-inbox"></i> 修改邮件模板</h2>
                    ...
                    <div class="col-md-12">
                        ...
                        <section class="tile color transparent-black">
                            ...
                            <div class="tile-body">
                                ...
                                <form class="form-horizontal" id="email_template_form" role="form" action="${pageContext.request.contextPath }/message/email/template/mod" method="post">
                                    <input type="hidden" id="id" name="id" value="${mail_template_vo.id}">
                                        ...
                                        <div class="col-sm-4" id="selectbox">
                                            <select class="chosen-select chosen-transparent form-control" id = "config_id" name="configId" parsley-trigger="change" parsley-required="true" parsley-error-container="#selectbox">
                                                ...
                                                <c:forEach items="${email_config_list }" var="email_configs">
                                                    <c:if test="${mail_template_vo.configId eq email_configs.id}">
                                                        <option value="${email_configs.id}" selected="selected">${email_configs.name}</option>
                                                    </c:if>
                                                    <c:if test="${mail_template_vo.configId ne email_configs.id}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" id="name" name="name" value="${mail_template_vo.name}" oldname="${mail_template_vo.name}" parsley-trigger="change" parsley-required="true" parsley-minlength="5" parsley-maxlength="50" parsley-checkemailtemplatename="true">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" id="subject" name="subject" value="${mail_template_vo.subject}" parsley-trigger="change"   parsley-required="true" parsley-minlength="5" parsley-maxlength="50">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" id="recipient" name="recipient" value="${mail_template_vo.recipient}"  parsley-trigger="change" parsley-required="true"  parsley-minlength="2" parsley-maxlength="50" parsley-validation-minlength="1">
                                        </div>
                                    </div>
                                    <%--<div class="form-group">--%>
                                        <%--<label for="email_content" class="col-sm-2 control-label">邮件正文*</label>--%>
                                        <%--<div class="col-sm-4">--%>
                                            <%--<textarea class="note-editable" id="email_content" name="content" style="visibility:hidden" parsley-trigger="change" parsley-required="true" parsley-minlength="2" parsley-maxlength="1000" parsley-validation-minlength="1">${mail_template_vo.content}</textarea>--%>
                                        <%--</div>--%>
                                    <%--</div>--%>
                                    ...
                                    <div class="form-group transparent-editor">
                                        ...
                                        <div class="col-sm-4" style="width:600px;">
                                            ...
                                            <textarea class="note-editable" id="email_content_check" name="content" style="visibility:hidden" parsley-trigger="change" parsley-required="true" parsley-minlength="2" parsley-maxlength="1000" parsley-validation-minlength="1">${mail_template_vo.content}</textarea>
                                        </div>
                                    </div>
...
<script>
    ...
    $(function(){
        ...
        $(".note-editable")[0].innerHTML = $("#email_content_check").val();
