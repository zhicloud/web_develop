      ...
      <div class="row">
        ...
        <div id="content" class="col-md-12">
          ...
          <div class="pageheader">
            ...
            <h2><i class="fa fa-inbox"></i> 新增邮件配置</h2>
              ...
              <div class="col-md-12">
                ...
                <section class="tile color transparent-black">
                  ...
                  <div class="tile-body">
                    ...
                    <form class="form-horizontal" id="email_config_form" role="form" action="${pageContext.request.contextPath }/message/email/config/add" method="post">
                      <div class="form-group">
                        <label for="name" class="col-sm-2 control-label" >邮件配置名称*</label>
                        <div class="col-sm-4">
                          <input type="text" class="form-control" id="name" name="name" value="" parsley-trigger="change" parsley-required="true" parsley-minlength="5" parsley-maxlength="50" parsley-checkemailconfigname="true">
                        </div>
                      </div>
                        ...
                        <div class="form-group">
                            <label for="is_auth1" class="col-sm-2 control-label" >是否要求身份验证*</label>
                            <div class="col-sm-8">
                                <div class="radio radio-transparent col-md-2">
                                    <input type="radio" name="isAuth" id="is_auth1" value="0">
                                    <label for="is_auth1">否</label>
                                </div>
                                <div class="radio radio-transparent col-md-2">
                                    <input type="radio" name="isAuth" id="is_auth2" value="1" checked="checked">
                                    <label for="is_auth2">是</label>
                                </div>
                            </div>
                        </div>
                      ...
                      <div class="col-sm-4">
                        <input type="text" class="form-control" id="sender" name="sender" value="" parsley-trigger="change" parsley-required="true" parsley-minlength="5" parsley-maxlength="50">
                      </div>
                      </div>
