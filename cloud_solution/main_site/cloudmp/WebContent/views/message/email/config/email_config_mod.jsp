                            ...
                            <div class="tile-body">
                                ...
                                <form class="form-horizontal" id="email_config_form" role="form" action="${pageContext.request.contextPath }/message/email/config/mod" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="email" class="form-control" id="senderAddress" name="senderAddress" value="${mail_config_vo.senderAddress}" parsley-trigger="change"   parsley-type="email" parsley-required="true" >
                                        </div>
                                    </div>
