                    ...
                    <div class="col-md-12">
                        ...
                        <section class="tile color transparent-black">
                            ...
                            <div class="tile-header">
                                <h3><a href="<%=request.getContextPath() %>/message/record/email/list"    style="color:#FAFAFA;cursor:pointer;padding-right:10px;"> <i class="fa fa-reply"></i></a>输入邮件模板信息</h3>
                            </div>
                            <!-- /tile header -->
                            ...
                            <div class="tile-body">
                                ...
                                <div class="form-group">
                                        <label for="name" class="col-sm-2 control-label" >发送人邮箱</label>
                                        <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <label for="code" class="col-sm-2 control-label">收件人邮箱</label>
                                        <div class="col-sm-4">
                                    ...
                                    <div class="form-group transparent-editor">
                                        ...
                                        <div class="col-sm-4" style="width:600px;">
                                            ...
                                            <textarea class="note-editable" id="email_content_check" name="content" style="visibility:hidden" parsley-trigger="change" parsley-required="true" parsley-minlength="2" parsley-maxlength="1000" parsley-validation-minlength="1">${message_record_vo.content}</textarea>
                                        </div>
                                    </div>
                                </form>
                            </div>
