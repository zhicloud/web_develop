...
<!DOCTYPE html>
<!-- warehouse_manage_add_amount.jsp -->
<html>
  <head>
      ...
      <div class="row">
        ...
        <div id="content" class="col-md-12">
          ...
          <div class="pageheader">
            ...
            <h2><i class="fa fa-desktop"></i> 增加仓库库存量</h2>
          ...
          <div class="col-md-12">
                  ...
                  <div class="tile-body">
                    ...
                    <form class="form-horizontal" id="addAmountForm" role="form" action="<%=request.getContextPath() %>/warehouse/addAmount" method="post">
                      <input type="hidden" id="old_amount_input" value="${hostWarehouse.totalAmount }">
                      <input type="hidden" name="id" value="${hostWarehouse.id }">
                      ...
                      <div class="form-group">
                        <label for="input01" class="col-sm-2 control-label">增加库存数量*</label>
                        <div class="col-sm-4">
                     ...
                     <div class="form-group form-footer footer-white">
                        <div class="col-sm-offset-4 col-sm-8">
                          <button type="button" class="btn btn-greensea" onclick="saveAddAmount();"><i class="fa fa-plus"></i>
                              <span> 增 加</span></button>
