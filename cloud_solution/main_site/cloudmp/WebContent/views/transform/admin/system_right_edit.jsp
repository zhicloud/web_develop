...
var tempbillid = "${systemRight.billid}";
...
function saveForm(){
	...
	if(form.parsley('isValid')){
		...
		var url = "<%=request.getContextPath()%>/transform/rightadmin/saveright"
		jQuery.ajax({
	  	 	type: "POST",
	  	 	async:false,
	   		url: url,
	     	...
	     	if(obj.status=="success"){
	     		window.location.href = "<%=request.getContextPath()%>/transform/rightadmin/index";
	     	}else{
...
<!-- Page content -->
        <div id="content" class="col-md-12">
          ...
          <div class="pageheader">
            ...
            <h2><i class="fa fa-mortar-board"></i> 
            <c:if test="${empty systemRight}">创建功能权限</c:if>
            <c:if test="${!empty systemRight}">修改功能权限</c:if>	
            </h2>
              ...
              <div class="col-md-12">
                ...
                <section class="tile color transparent-black">
                  ...
                  <div class="tile-header">
                    <h3><a href="<%=request.getContextPath() %>/transform/rightadmin/index"    style="color:#FAFAFA;cursor:pointer;padding-right:10px;"> <i class="fa fa-reply"></i></a>编辑功能权限信息</h3>
                    <div class="controls">
                    ...
                    <form class="form-horizontal" role="form" parsley-validate id="basicvalidations">
                     ...
                     <c:if test="${!empty systemRight}">
                      ...
                      <div class="form-group">
                        <label for="name" class="col-sm-2 control-label">权限名称*</label>
                        <div class="col-sm-4">
                          <input value="${systemRight.name }" type="text" class="form-control" id="name" parsley-required="true"  parsley-maxlength="100">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <label for="code" class="col-sm-2 control-label">权限编码*</label>
                        <div class="col-sm-4">
                          <input value="${systemRight.code }" type="text" class="form-control" id="code" parsley-required="true"  parsley-maxlength="100">
                        </div>
                      </div>
                      </c:if>                      
                      <!-- modify -->
