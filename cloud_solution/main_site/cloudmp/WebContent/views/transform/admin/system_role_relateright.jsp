...
function setMenu(obj){
	...
	jQuery.ajax({
 	 	type: "POST",
 	 	async:false,
  		url: "<%=request.getContextPath() %>/transform/roleadmin/getMenuTreewithRight",
 		data: urldata,
...
function saveMenu(){
	...
	for(var i=0;i<note.length;i++){
		if(note[i].data.isright=="true"){
			menuids.push(note[i].data.id);
		}
	}
	
	var urldata = "rightids="+menuids.join(",")+"&roleid="+temproleid;
	jQuery.ajax({
  	 	type: "POST",
  	 	async:false,
   		url: "<%=request.getContextPath() %>/transform/roleadmin/saveroleright",
  		data: urldata,
  		contenttype :"application/x-www-form-urlencoded;charset=utf-8", 
   		success: function(result){
   		  var obj = eval("("+result+")");
    ...
    <div class="row">
        ...
        <div id="content" class="col-md-12">
          ...
          <div class="pageheader">
            ...
            <h2><i class="fa fa-meh-o"></i> 设置功能权限</h2>
