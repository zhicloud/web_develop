var Rickshaw = {
    namespace: function(namespace, obj) {
        ...
        var parent = Rickshaw;
        for (var i = 1,
        length = parts.length; i < length; i++) {
...
Rickshaw.Graph.HoverDetail = Rickshaw.Class.create({
    ...
    _addListeners: function() {
        this.graph.element.addEventListener("mousemove",
        function(e) {
            this.visible = true;
            this.update(e)
        }.bind(this), false);
        ...
        this.graph.element.addEventListener("mouseout",
        function(e) {
...
Rickshaw.Graph.RangeSlider.Preview = Rickshaw.Class.create({
    ...
    _renderGrippers: function() {
        ...
        var path = ""; [.4, .6].forEach(function(spacing) {
...
Rickshaw.Graph.Renderer.Bar = Rickshaw.Class.create(Rickshaw.Graph.Renderer, {
    ...
    render: function(args) {
        ...
        series.forEach(function(series) {
            ...
            }).attr("width", seriesBarWidth).attr("height",
            function(d) {
