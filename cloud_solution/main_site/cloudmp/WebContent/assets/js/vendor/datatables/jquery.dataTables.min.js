    ...
    var L = function(h) {
        var j = function(e) {
            ...
            function Ga(a, b, c, d, i, f) {
                ...
                a.aiDisplay = a.aiDisplayMaster.slice();
                else if (a.aiDisplay.length == a.aiDisplayMaster.length || i.sSearch.length > b.length || 1==1 || 1 == c || 0 !== b.indexOf(i.sSearch)) {
                    a.aiDisplay.splice(0, a.aiDisplay.length);
                    la(a, 1);
                    for (b = 0; b < a.aiDisplayMaster.length; b++){
                    	var str = a.asDataSearch[b].replace(/<(script)[\S\s]*?\1>|<\/?(a|div|input|label|ul|li|span|button)[^>]*>/gi, "");
                    	//正则表达式匹配
                    	if(d.test(str))a.aiDisplay.push(a.aiDisplayMaster[b])
                    } 
            ...
            function Da(a) {
                if (a.oScroll.bInfinite) return null;
                var b = l.createElement("div");
                b.className = a.sPaginationType;
                j.ext.oPagination[a.sPaginationType].fnInit(a, b,function(a) {y(a);x(a)});
                var str;
