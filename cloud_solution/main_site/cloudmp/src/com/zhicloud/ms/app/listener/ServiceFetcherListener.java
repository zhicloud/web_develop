...
public class ServiceFetcherListener implements Servlet {
	...
	public void init(ServletConfig config) throws ServletException {
		...
		int[] nodeList = new int[] { NodeTypeDefine.DATA_SERVER, NodeTypeDefine.CONTROL_SERVER, NodeTypeDefine.NODE_CLIENT, NodeTypeDefine.STORAGE_SERVER, NodeTypeDefine.INTELLIGENT_REOUTER,NodeTypeDefine.HTTP_GATEWAY };
