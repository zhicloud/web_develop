...
public class TransFormPrivilegeConstant {
    ...
    public static final String desktop_warehouse_host_update_displayname = "desktop_warehouse_host_update_displayname";     //修改主机显示名
    ...
    public static final String server_migrate = "server_migrate";  //服务器备份新增
