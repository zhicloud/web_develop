...
public class HttpGatewayAsyncChannel extends HttpGatewayChannelExt {
   ...
   public synchronized JSONObject hostReset(String uuid) throws MalformedURLException, IOException {
    ...
    public synchronized JSONObject networkDeviceQuery(int level, String target, int type) throws MalformedURLException, IOException {
        return this.networkDeviceQuery(level, target, type, this.callback);
    }

    public synchronized JSONObject networkDeviceAttach(int level, String target, int type, int index, int networkId) throws MalformedURLException, IOException {
        return this.networkDeviceAttach(level, target, type, index, networkId, this.callback);
    }

    public synchronized JSONObject networkDeviceDetach(int level, String target, int type, int index, int networkId) throws MalformedURLException, IOException {
        return this.networkDeviceDetach(level, target, type, index, networkId, this.callback);
    }

    public synchronized JSONObject bondGroupQuery(int level, String target, int type) throws MalformedURLException, IOException {
        return this.bondGroupQuery(level, target, type, this.callback);
    }

    public synchronized JSONObject bondGroupCreate(int level, String target, int type, String name) throws MalformedURLException, IOException {
        return this.bondGroupCreate(level, target, type, name, this.callback);
    }

    public synchronized JSONObject bondGroupModify(int level, String target, int type, String name, int index, int mode, String ip, String netmask) throws MalformedURLException, IOException {
        return this.bondGroupModify(level, target, type, name, index, mode, ip, netmask, this.callback);
    }

    public synchronized JSONObject bondGroupDelete(int level, String target, int type, int index) throws MalformedURLException, IOException {
        return this.bondGroupDelete(level, target, type, index, this.callback);
    }
