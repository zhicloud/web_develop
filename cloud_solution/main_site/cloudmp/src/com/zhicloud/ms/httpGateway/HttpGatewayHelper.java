...
public JSONObject snapshotCreate(int type,String uuid, int mode, String index, String callback) throws MalformedURLException, IOException {
    ...
    public JSONObject networkDeviceQuery(int level, String target, int type, String callback) throws MalformedURLException, IOException {
        String url = this.baseUrl + "server?";
        url += "command=query_network_device&";
        url += "session_id=" + this.sessionId + "&";

        if (logger.isDebugEnabled()) {
            logger.info("query_network_device() -> url=[" + url + "]");
        }
    ...
    public JSONObject networkDeviceAttach(int level, String target, int type, int index, int networkId, String callback) throws MalformedURLException, IOException {
        String url = this.baseUrl + "server?";
        url += "command=attach_network_device&";
        url += "session_id=" + this.sessionId + "&";

        if (logger.isDebugEnabled()) {
            logger.info("attach_network_device() -> url=[" + url + "]");
        }
        ...
        postDataMap.put("type", String.valueOf(type));
        postDataMap.put("index", String.valueOf(index));
        postDataMap.put("network_id", String.valueOf(networkId));
        postDataMap.put("callback", callback);
    ...
    public JSONObject networkDeviceDetach(int level, String target, int type, int index, int networkId, String callback) throws MalformedURLException, IOException {
        String url = this.baseUrl + "server?";
        url += "command=detach_network_device&";
        url += "session_id=" + this.sessionId + "&";

        if (logger.isDebugEnabled()) {
            logger.info("detach_network_device() -> url=[" + url + "]");
        }
    ...
    public JSONObject bondGroupQuery(int level, String target, int type, String callback) throws MalformedURLException, IOException {
        String url = this.baseUrl + "server?";
        url += "command=query_bond_group&";
        url += "session_id=" + this.sessionId + "&";

        if (logger.isDebugEnabled()) {
            logger.info("query_bond_group() -> url=[" + url + "]");
        }
    ...
    public JSONObject bondGroupCreate(int level, String target, int type, String name, String callback) throws MalformedURLException, IOException {
        String url = this.baseUrl + "server?";
        url += "command=create_bond_group&";
        url += "session_id=" + this.sessionId + "&";

        if (logger.isDebugEnabled()) {
            logger.info("create_bond_group() -> url=[" + url + "]");
        }
    ...
    public JSONObject bondGroupModify(int level, String target, int type, String name, int index, int mode, String ip, String netmask, String callback) throws MalformedURLException, IOException {
        String url = this.baseUrl + "server?";
        url += "command=modify_bond_group&";
        url += "session_id=" + this.sessionId + "&";

        if (logger.isDebugEnabled()) {
            logger.info("modify_bond_group() -> url=[" + url + "]");
        }
        ...
        postDataMap.put("mode", String.valueOf(mode));
        postDataMap.put("ip", ip);
        postDataMap.put("netmask", netmask);
        postDataMap.put("callback", callback);
    ...
    public JSONObject bondGroupDelete(int level, String target, int type, int index, String callback) throws MalformedURLException, IOException {
        String url = this.baseUrl + "server?";
        url += "command=delete_bond_group&";
        url += "session_id=" + this.sessionId + "&";

        if (logger.isDebugEnabled()) {
            logger.info("delete_bond_group() -> url=[" + url + "]");
        }
