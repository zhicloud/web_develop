...
//  }
    ...
    public synchronized JSONObject isoImageUpload(String name, String target, String description, String group, String user,int diskType,String uuid, String callback) throws MalformedURLException, IOException
    {
        try
        {
            checkSessionRefresh();
            JSONObject result = helper.isoImageUpload(name, target, description, group, user,diskType,uuid, callback);
            if( HttpGatewayReturnCode.SESSION_NOT_FOUND.equals(HttpGatewayResponseHelper.getReturnCode(result)) )
            {
                helper = null;
            }
    ...
    public synchronized JSONObject hostFlushDiskMigration(String uuid, int disk, int mode, String image, String callback) throws MalformedURLException, IOException {
    	try {
    		this.checkSessionRefresh();
    		JSONObject result = helper.hostFlushDiskMigration(uuid, disk, mode, image, callback);
	...
	public synchronized JSONObject hostMigrate(String uuid, String target, int type, String callback) throws MalformedURLException, IOException {
        try
        {
            checkSessionRefresh();
            JSONObject result = helper.hostMigrate(uuid, target, type, callback);
            if( HttpGatewayReturnCode.SESSION_NOT_FOUND.equals(HttpGatewayResponseHelper.getReturnCode(result)))
            {
                helper = null;
            }
