...
public class HttpGatewayAsyncChannel extends HttpGatewayChannelExt {
    ...
    public synchronized JSONObject hostFlushDiskMigration(String uuid, int disk, int mode, String image) throws MalformedURLException, IOException {
    	return this.hostFlushDiskMigration(uuid, disk, mode, image, this.callback);
    }
