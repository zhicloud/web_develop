      ...
      <div class="row">
        ...
        <div id="content" class="col-md-12">
          ...
          <div class="pageheader">
            ...
            <h2><i class="fa fa-cogs"></i> 修改主机配置</h2>
              ...
              <div class="col-md-12">
                ...
                <section class="tile color transparent-black">
                  ...
                  <div class="tile-header"> 
                     <h3><a href="<%=request.getContextPath() %>/chcm/all"    style="color:#FAFAFA;cursor:pointer;padding-right:10px;"> <i class="fa fa-reply"></i></a>输入主机配置信息</h3>
                    <div class="controls">
                  ...
                  <div class="tile-body">
                    ...
                    <form class="form-horizontal" role="form" parsley-validate id="basicvalidations" action="<%=request.getContextPath() %>/chcm/${chcm.id}/update" method="post"   >
                      
                      <div class="form-group">
                        <label for="input01" class="col-sm-2 control-label">配置名称 *</label>
                        <div class="col-sm-4">
                          <input type="text" class="form-control" id="name" name="name" oldname="${chcm.name}" value="${chcm.name }"  parsley-trigger="change" parsley-required="true" parsley-checkdesktoptypename="true" parsley-minlength="2" parsley-maxlength="50" parsley-validation-minlength="1">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-8"> 
                          <div class="radio radio-transparent col-md-2">
                            <input type="radio" name="dataDisk" id="optionsRadios31" value="10"  onclick="$('#diskdiy').attr('disabled','disabled');$('#diskdiy').val('')">
...
<!--                       </div> -->
                      ...
                      <div class="form-group my_div">
                        ...
                        <div class="col-sm-10">
                          <div class="radio radio-transparent col-md-8">
		                         <c:if test="${chcm.sysImageId == null }">
		                         	    <input type="radio" id="create_from_img" name="sysDiskType" value="from_sys_image"   onclick="$('#sysImageId').removeAttr('disabled');">                          
		                         </c:if>
		                         <c:if test="${chcm.sysImageId != null }">
	                            ...
	                            <c:forEach items="${imageList }" var="sdi">
                                 	<c:if test="${sdi.realImageId!=null&&sdi.id==chcm.sysImageId }">
                                 		<option value="${sdi.id }" selected>${sdi.displayName }</option>
                                 	</c:if>
                             </c:forEach>   
                            <c:forEach items="${imageList }" var="sdi">
                                 	<c:if test="${sdi.realImageId!=null &&sdi.id!=chcm.sysImageId  }">
                      ...
                      <div class="form-group my_div">
                        ...
                        <div class="col-sm-10">
                          ...
                          <div class="radio radio-transparent col-md-8">
                            <input type="hidden" name="emptyDisk" id="emptyDisk" value="${chcm.sysDiskText }"/>
                            <c:if test="${chcm.sysImageId == null }">
                            <input type="radio" id="empty_system" name="sysDiskType" value="from_empty" checked onclick="$('#sysImageId').attr('disabled','disabled');">
	                         </c:if>
	                         <c:if test="${chcm.sysImageId != null }">
                            ...
                            <div class="col-sm-8" >${chcm.sysDiskText }GB<div class="noUiSlider"  style="margin-left: 40px;"      id="slider"    ></div></div>500GB
                            <br><span id="now">${chcm.sysDiskText }</span>GB
                          </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-4" id="operationSystemSelectbox">
                           ...
                           <c:if test="${chcm.getOperationSystem()=='Windows_7_32'}">
                           ...
                           <c:if test="${chcm.getOperationSystem()=='Windows_7_64'}">
                          	   <option value="Windows_7_64">Windows_7_64</option>
	                           <option value="Windows_7_32">Windows_7_32</option>
	                           <option value="CentOS_6_32">CentOS_6_3</option>
	                           <option value="CentOS_6_64">CentOS_7_32</option>
                           ...
                           <c:if test="${chcm.getOperationSystem()=='CentOS_6_32'}">
                           	   <option value="CentOS_6_32">CentOS_6_3</option>
                          	   <option value="Windows_7_64">Windows_7_64</option>
	                           <option value="Windows_7_32">Windows_7_32</option>
	                           <option value="CentOS_6_64">CentOS_7_32</option>
                           ...
                           <c:if test="${chcm.getOperationSystem()=='CentOS_7_32'}">
                           	   <option value="CentOS_6_64">CentOS_7_32</option>
                          	   <option value="Windows_7_64">Windows_7_64</option>
	                           <option value="Windows_7_32">Windows_7_32</option>
	                           <option value="CentOS_6_32">CentOS_6_3</option>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-4" id="supportH264selectbox">
                           ...
                           <option value="1" <c:if test="${chcm.supportH264==1 }">selected</c:if>>H.264编码</option> 
<%--                            <option value="1" <c:if test="${chcm.supportH264==1 }">selected</c:if>>局部H.264编码</option>    --%>
                      ...
                      <input id="sH264" type="hidden" value="${chcm.supportH264}"/>
