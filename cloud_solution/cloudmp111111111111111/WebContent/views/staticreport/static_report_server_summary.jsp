...
<!DOCTYPE html>
<!-- static_report_server_summary.jsp -->
<html>
  <head>
    <title>服务器概览</title>
...
function getData(obj,startdate,enddate,type){
	$.ajax({
        type:"POST",
        url:"<%=request.getContextPath()%>/staticreport/getserverdata",
...
function exportStaticData(obj){
  ...
  <body class="bg-1">
      ...
      <div class="row">
        ...
        <div id="content" class="col-md-12">
          ...
          <div class="pageheader">
            ...
            <h2><i class="fa fa-area-chart"></i> 服务器概览</h2>
                  ...
                  <div class="tile-body no-vpadding" style="margin-top:-10px;">
                    ...
                    <div class="row">
                      <div class="col-md-8 text-left">
						<div style="float: left;" >服务器:<font id="host_name"></font> 概览</div><br>
                    ...
                    <div class="row" style="padding-left:15px;padding-top:10px;">
                          ...
                          <button type="button" class="btn btn-green btn-sm" onclick="exportStaticData('sscpu')">导出Excel表</button>
                          </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row" style="padding-left:15px;padding-top:10px;">
                          ...
                          <button type="button" class="btn btn-green btn-sm" onclick="exportStaticData('sswrite')">导出Excel表</button>
                          </div>
                    </div>                    
					<div class="row">
    ...
    function backhome(){
    	window.location.href = "<%=request.getContextPath()%>/staticreport/serverindex";
    } 
    function viewcloudmore(){
    	window.location.href = "<%=request.getContextPath()%>/staticreport/server/detail/"+tempcloudid;
    }
    //云主机切换
