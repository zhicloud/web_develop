...
<!DOCTYPE html>
<!-- static_report_cloud_detail.jsp -->
<html>
  <head>
    <title>云主机明细</title>
...
function backhome(obj){
	window.location.href = "<%=request.getContextPath()%>/staticreport/cloudhost/"+obj;
}
//云主机切换
...
function getData(obj,startdate,enddate){
	$.ajax({
        type:"POST",
        url:"<%=request.getContextPath()%>/staticreport/gethostdetaildata",
                  ...
                  <div class="tile-body no-vpadding" style="margin-top:-10px;">
                    ...
                    <div class="row">
                      <div class="col-md-8 text-left">
						<div style="float: left;" >云主机:<font id="host_name"></font></div><br>
                        ...
                        <div style="width:80px;float: left;">
                        	<span class="label label-default" style="cursor:pointer;" onclick="backhome('${cloudid}')">返回概览</span>
                        </div>
                      </div>
