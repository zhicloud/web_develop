                ...
                <section class="tile color transparent-black">
                 ...
                 <!-- tile widget -->
                  ...
                  <div class="tile-body">
                    ...
                    <form class="form-horizontal" role="form"  parsley-validate id="basicvalidations" action="<%=request.getContextPath() %>/image/${image.id}/update" method="post"   >
