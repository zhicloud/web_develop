                    ...
                    <div class="modal fade" id="backup" tabindex="-1" role="dialog" aria-labelledby="modalConfirmLabel" aria-hidden="true">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form class="form-horizontal" role="form"  id="basicvalidations_password" action="<%=request.getContextPath() %>/tenant/addbackup" method="post"   >
...
function refreshBackupProgress(){
	...
	jQuery.ajax({
		url: path+'/tenant/getbackupprogress',
		type: 'get',
...
function refreshResumeProgress(){
	jQuery.ajax({
		url: path+'/tenant/getresumprogress',
		type: 'get',
		data: 'uuid=' + '${host.realHostId}',
		dataType: 'json', 
		async: false,
