...
<body class="bg-1">
		...
		<div class="row">
			...
			<div id="content" class="col-md-12">
				...
				<div class="pageheader">
					<h2><i class="fa fa-mortar-board"></i>功能权限维护</h2>
				</div>
				<!-- /page header -->
				...
				<div class="main">
                  ...
                  <div class="tile-header"> 
                     <button type="button" class="btn btn-red add" onclick="updateright('add',null)">
                              <i class="fa fa-plus"></i>
                              <span> 新增权限</span>
                    </button> 
                    <button type="button" class="btn btn-green file-excel-o" onclick="exportData('/export/rightdata')">
                  ...
                  <div class="tile-body no-vpadding"> 
					...
					<c:forEach items="${systemRightList}" var="systemRight">
                    		<tr class="odd gradeX">
						    <td>
									<div class="checkbox check-transparent">
									  <input type="checkbox" value="${systemRight.billid }" id="${systemRight.billid }">
									  <label for="${systemRight.billid }"></label>
									</div>
                             </td>
                            <td class="cut">${systemRight.name }</td>
                            <td class="cut">${systemRight.code }</td>
                            <td class="cut">${systemRight.menuname }</td>
                            <td class="cut">${systemRight.insert_date }</td>
                            <td> 
                            <button type="button" class="btn btn-primary btn-xs" onclick="updateright('modify','${systemRight.billid}')">修改</button>
                            </td>                           
                        </tr> 
                    	</c:forEach>                         
                        </tbody>
	...
	//修改信息页面跳转
	function updateright(obj,billid){
		window.location.href = "<%=request.getContextPath()%>/transform/rightadmin/beforeedit?type="+obj+"&billid="+billid;
	}
	//删除数据
	function confirmreturn(){
		...
		jQuery.ajax({
	  	 	type: "POST",
	  	 	async:false,
	   		url: "<%=request.getContextPath() %>/transform/rightadmin/deleteright",
