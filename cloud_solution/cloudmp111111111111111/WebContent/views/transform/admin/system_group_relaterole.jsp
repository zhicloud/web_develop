...
function saveRoleGroup(){
	...
	var urldata = "roleids="+array.join(",")+"&groupid="+temproleid;
	jQuery.ajax({
  	 	type: "POST",
  	 	async:false,
   		url: "<%=request.getContextPath() %>/transform/groupadmin/savegrouprole",
  		data: urldata,
    ...
    <div class="row">
        ...
        <div id="content" class="col-md-12">
          ...
          <div class="pageheader">
            ...
            <h2><i class="fa fa-group"></i> 关联角色</h2>
          ...
          <div class="col-md-12">
                  ...
                  <div class="tile-body no-vpadding" style="height:440px;"> 
					...
					<c:forEach items="${roleList}" var="systemRole">
						    ...
						    <td>
									<div class="checkbox check-transparent">
									<c:if test="${empty systemRole.groupid }">
										<input type="checkbox" name="unchoosecheck" value="${systemRole.billid }" id="${systemRole.billid }">
									</c:if>
									<c:if test="${!empty systemRole.groupid }">
										<input type="checkbox" name="unchoosecheck" value="${systemRole.billid }" id="${systemRole.billid }" checked>
									</c:if>									
