...
<html>
  ...
  <body class="bg-1">
      ...
      <div class="row">
        ...
        <div id="content" class="col-md-12">
          ...
          <div class="pageheader">
            ...
            <h2><i class="fa fa-group"></i> 角色组管理</h2>
          ...
          <div class="col-md-12">
                  ...
                  <div class="tile-header"> 
                     <button type="button" class="btn btn-red add" onclick="updategroup('add',null)">
                  ...
                  <div class="tile-body no-vpadding"> 
					...
					<c:forEach items="${systemGroupList}" var="systemGroup">
                    		<tr class="odd gradeX">
						    <td>
									<div class="checkbox check-transparent">
									  <input type="checkbox" value="${systemGroup.billid }" id="${systemGroup.billid }">
                            ...
                            <td> 
                            <button type="button" class="btn btn-primary btn-xs" onclick="updategroup('modify','${systemGroup.billid}')">修改</button>
                              <div class="btn-group">
                                  <button type="button" class="btn btn-default btn-xs dropdown-toggle" data-toggle="dropdown">
                                    操作 <span class="caret"></span>
                                  </button>
                                  <ul class="dropdown-menu" role="menu"> 
                                    <li><a href="#" onclick="relateuser('${systemGroup.billid}')">关联用户</a></li>
                                    <li><a href="#" onclick="relaterole('${systemGroup.billid}')">关联角色</a></li>
                                  </ul>
                              </div>
                            </td>                           
                        </tr> 
	...
	//修改信息页面跳转
	function updategroup(obj,billid){
		window.location.href = "<%=request.getContextPath()%>/transform/groupadmin/beforeedit?type="+obj+"&billid="+billid;
	}
	//关联用户信息页面跳转
	function relateuser(billid){
		window.location.href = "<%=request.getContextPath()%>/transform/groupadmin/beforerelateuser?billid="+billid;
	}
	//关联角色信息页面跳转
	function relaterole(billid){
		window.location.href = "<%=request.getContextPath()%>/transform/groupadmin/beforerelaterole?billid="+billid;
	}
	//删除数据
	function confirmreturn(){
		...
		$(datatable).each(function(){
			...
			jQuery.ajax({
		  	 	type: "POST",
		  	 	async:false,
		   		url: "<%=request.getContextPath() %>/transform/groupadmin/deletegroup",
