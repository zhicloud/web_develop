...
<html>
  ...
  <body class="bg-1">
      ...
      <div class="row">
        ...
        <div id="content" class="col-md-12">
          ...
          <div class="pageheader">
            ...
            <h2><i class="fa fa-chain-broken"></i> 功能菜单维护</h2>
          ...
          <div class="col-md-12">
                  ...
                  <div class="tile-header"> 
                     <button type="button" class="btn btn-red add" onclick="updatemenu('add',null)">
                              <i class="fa fa-plus"></i>
                              <span> 新增菜单</span>
                    </button>  
                    <button type="button" class="btn btn-green file-excel-o" onclick="exportData('/export/menudata')">
                  ...
                  <div class="tile-body no-vpadding"> 
					...
					<c:forEach items="${systemMenuList}" var="systemMenu">
                            ...
                            <td> 
                              ...
                              <button type="button" class="btn btn-red btn-xs" onclick="gotochildren('${systemMenu.billid}')">编辑子菜单</button> 
                            </td>                            
                        </tr> 
                    	</c:forEach>                         
                        </tbody>
	...
	function updatemenu(obj,billid){
		window.location.href = "<%=request.getContextPath()%>/transform/menuadmin/beforeedit?type="+obj+"&billid="+billid;
	}
	//菜单子页面跳转
	function gotochildren(obj){
		window.location.href = "<%=request.getContextPath() %>/transform/menuadmin/children?parentid="+obj;	
	}
	//删除数据
