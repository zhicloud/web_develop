				  ...
				  <section class="tile color transparent-black">
                      ...
                      <div class="tile-widget color transparent-black rounded-top-corners nopadding nobg">
                          ...
                          <ul class="nav nav-tabs tabdrop">
                              ...
                              <li class="active"><a href="#" data-toggle="tab" onclick="redirect('/dtsettimeoperation/shutdown/manage');">定时关机管理</a></li>
                      ...
                      <div class="tile-body">
                          ...
                          <form class="form-horizontal" role="form" parsley-validate id="shutdown_timer_form" action="<%=request.getContextPath() %>/dtsettimeoperation/updatecheck" method="post"   >
                              <input type="hidden" name="id" value="${timer.id}"/>
                              <input type="hidden" name="key" value="shutdown_timer"/>
                          ...
                          <div class="form-group form-footer footer-white">
                                  <div class="col-sm-offset-4 col-sm-8">
                                      <button type="button" class="btn btn-greensea" onclick="saveShutdownForm();"><i class="fa fa-plus"></i>
    ...
    jQuery.ajax({
        ...
        success: function(result)
        {
            if(result.status == "fail"){
                ...
                var form = jQuery("#shutdown_timer_form");
                form.parsley('validate');
                if(form.parsley('isValid')){
                    jQuery("#shutdown_timer_form").ajaxSubmit(options);
                }
            }
        }
    });
