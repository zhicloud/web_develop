...
<html>
  ...
  <body class="bg-1">
        ...
        <div id="content" class="col-md-12">
          ...
          <div class="col-md-12">
                  ...
                  <div class="tile-header">
                    ...
                    <button type="button" class="btn btn-green file-excel-o" onclick="exportData('/export/cscmdata')">
                  ...
                  <div class="tile-body no-vpadding"> 
                    ...
                    <div class="table-responsive">
                      ...
                      <table  class="table table-datatable table-custom table-sortable" id="basicDataTable">
                        ...
                        <tbody>
                          <c:forEach items="${serverTypeList}" var="chcm">
                    		<tr class="gradeX">
                    		<td>
								<div class="checkbox check-transparent">
                            ...
                            <td class="operatoricon">
                              <div class="btn-group">
                                  ...
                                  <ul class="dropdown-menu" role="menu"> 
                                    <li><a href="javascript:void(0);" onclick="updateType('${chcm.id }');">修改</a></li> 
                                    <li class="divider"></li>
                                    <li><a href="javascript:void(0);" onclick="deleteType('${chcm.id }');">删除</a></li>
                                  </ul>
                              </div>
                             </td>
                        </tr>
    ...
    function toDelete(){
    	jQuery.get(path + "/cscm/"+operid+"/delete",function(data){
        ...
        success: function(result)
        {
        	if(result.status == "fail"){
        		   $("#tipscontent").html("登录超时，请重新登录");
	        		...
	        		location.href = path + "/cscm/"+id+"/updateserverpage";  
