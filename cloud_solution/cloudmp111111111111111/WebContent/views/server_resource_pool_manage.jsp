...
<!DOCTYPE html>
<!-- server_resource_pool_manage.jsp -->
<html>
  <head>
      ...
      <div class="row">
        ...
        <div id="content" class="col-md-12">
          ...
          <div class="pageheader">
            ...
            <h2><i class="fa fa-life-buoy"></i> 计算资源池管理</h2>
					...
					<c:forEach items="${computerPool }" varStatus="i" var="cp">
                        ...
                        <div class="panel panel-greensea">
                          <div class="panel-heading title">
                            <h3 class="panel-title">计算资源池${i.count }</h3>
                          </div>
...
<!--                         <li><a href="#">删除该资源池</a></li> -->
    ...
    $(function(){
    	...
    	jQuery(".query_detail").click(function(){
	    	...
	    	window.location.href = path+"/csrpm/"+uuid+"/rd";
	    });
    	//查看主机详情
    	jQuery(".query_host_detail").click(function(){
	    	var uuid = jQuery(this).attr("cur_id");
	    	var name = jQuery(this).attr("cur_name");
	    	window.location.href = path+"/csrpm/"+uuid+"/"+name+"/hpdetail";
	    });
    	//创建资源池
