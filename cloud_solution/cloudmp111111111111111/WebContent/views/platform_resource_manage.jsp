...
<div id="wrap">
	...
	<div class="row">
		...
		<div id="content" class="col-md-12">
			<!-- page header -->
			<div class="pageheader"><h2><i class="fa fa-tachometer"></i>全局实时状态</h2></div>
...
<!--               </div>  -->
					<div class="card-container col-lg-3 col-sm-6 col-xs-12">
						<div class="card card-slategray hover">
							<div class="front"> 
								<div class="media">                   
									<span class="pull-left"><i class="fa fa-desktop media-object"></i></span>
									<div class="media-body">
										<big>云桌面</big>
								...
								<div class="progress-list">
									<div class="details"><div class="title">CPU利用率</div></div>
									<div class="status pull-right bg-transparent-black-1"><span id="tCpuUsage" class="animate-number" data-value="0" data-animation-duration="1500">0</span>%</div>
									<div class="clearfix"></div>
									<div class="progress progress-little progress-transparent-black"><div id="tCpuUsage_p" class="progress-bar animate-progress-bar" data-percentage="0%"></div></div>
								</div>
		
								<div class="progress-list">
									<div class="details"><div class="title">内存利用率</div></div>
									<div class="status pull-right bg-transparent-black-1"><span id="tMemoryUsage" class="animate-number" data-value="0" data-animation-duration="1500">0</span>%</div>
									<div class="clearfix"></div>
									<div class="progress progress-little progress-transparent-black"><div id="tMemoryUsage_p" class="progress-bar animate-progress-bar" data-percentage="0%"></div></div>
								</div>
								
								<div class="progress-list">
									<div class="details"><div class="title">硬盘利用率</div></div>
									<div class="status pull-right bg-transparent-black-1"><span id="tDiskUsage" class="animate-number" data-value="0" data-animation-duration="1500">0</span>%</div>
									<div class="clearfix"></div>
									<div class="progress progress-little progress-transparent-black"><div id="tDiskUsage" class="progress-bar animate-progress-bar" data-percentage="0%"></div></div>
								</div>
		                		</div>
		                		<div class="back" style="height:177px;"><a href="<%=request.getContextPath() %>/warehouse/all" style="padding-top:25px;"><i class="fa fa-bar-chart-o fa-4x"></i><span>查看云桌面详情</span></a></div>
						</div>
					</div>
	            </div>
	            <!-- /cards -->
					...
					<div class="col-md-4">
							...
							<div class="tile-widget">
								<div class="progress-list with-heading">
									<div class="details"><div class="title"><h2><i class="fa fa-hdd-o"></i> <span id="pDiskRemain" class="animate-number" data-value="0" data-animation-duration="1600">0</span> GB</h2></div></div>
							    		<div class="status pull-right bg-transparent-black-1"><span id="pDiskUsage" class="animate-number" data-value="0" data-animation-duration="1500">0</span>%</div>
							    		<div class="clearfix"></div>
							    		<div class="progress progress-little progress-transparent-black" style="margin-bottom: 5px"><div id="pDiskUsage_p" class="progress-bar animate-progress-bar" data-percentage="0%"></div></div>
							  	</div>  
							...
							<!-- tile body -->
							<div class="tile-body paddingtop"><div id="rickshaw-chart"></div></div>
							<!-- /tile body -->
		                </section>
		                <!-- /tile -->
		                ...
		                <section class="tile color transparent-black">
							...
							<!-- tile body -->
							<div class="tile-body"><div id="realtime-chart" style="height: 195px;"></div></div>
							<!-- /tile body -->
		                </section>
		                <!-- /tile -->
            			</div>
