                    ...
                    <div class="col-md-12">
                        ...
                        <section class="tile color transparent-black">
                            ...
                            <ul class="nav nav-tabs tabdrop">
                                ...
                                <li class="active"><a href="#" data-toggle="tab" onclick="redirect('/message/sms/config/list');">短信配置管理</a></li>
                            ...
                            <div class="tile-header">
                                <button type="button" class="btn btn-red delete" id="config_add">
                                    <i class="fa fa-plus"></i>
                                    <span> 新增短息配置 </span>
                                </button>
			                    <button type="button" class="btn btn-green file-excel-o" onclick="exportData('/export/smsconfiglistdata')">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table  class="table table-datatable table-custom table-sortable" id="basicDataTable">
                                        ...
                                        <tr>
                                            ...
                                            <th class="sortable sort-amount">短息配置名称</th>
                                            <th class="sortable sort-amount">发送账户</th>
                                        ...
                                        <c:forEach items="${sms_config_list}" var="sms_configs">
                                            <tr class="gradeX">
                                                <td>
                                                    <div class="checkbox check-transparent">
                                                        <input type="checkbox" value="${sms_configs.id}" name="checkboxid" id="chck${sms_configs.id}" >
                                                        <label for="chck${sms_configs.id}"></label>
                                                    </div>
                                                </td>
                                                <td class="cut"><a hrep="javascript:void(0);" onclick="mod_config('${sms_configs.id }');" style="color:#FAFAFA;cursor:pointer">${sms_configs.configName}</a></td>
                                                <td class="cut">${sms_configs.name}</td>
                                                <td class="cut"><fmt:formatDate
                                                        value="${sms_configs.createTimeDate}"
                                                        pattern="yyyy-MM-dd HH:mm:ss"/></td>
                                                <td class="cut"><fmt:formatDate
                                                        value="${sms_configs.modifiedTimeDate}"
                                                        pattern="yyyy-MM-dd HH:mm:ss"/></td>
                                                <td>
                                                    <div class="btn-group">
                                                        <button type="button"
                                                        ...
                                                        <ul class="dropdown-menu" role="menu">
                                                            <li><a href="#" onclick="mod_config('${sms_configs.id }');">修改</a></li>
                                                            <li class="divider"></li>
                                                            <li><a href="#" onclick="del_config('${sms_configs.id }');">删除</a></li>
                                                        </ul>
                                                    </div>
                                                </td>
                                            </tr>
                                            ...
                                            <div class="modal-body">
                                                <form role="form">
                                                    ...
                                                    <div class="form-group">
                                                        <label style="align:center;" id="confirmcontent">确定要删除该短息配置吗？</label>
                                                    </div>
...
<script>
    ...
    $(function(){
        ...
        $("#config_add").click(function(){
            window.location.href = "${pageContext.request.contextPath}/message/sms/config/add";
        });
        ...
        jQuery("#submit_oper").click(function(){
            ...
            if(option=="delete"){
                ...
                if(myids.length < 1){
                    $("#tipscontent").html("请选择要删除的短息配置");
                    $("#dia").click();
                    return;
                }
                ids = myids;
                $("#confirmcontent").html("确定要删除所选短息配置吗？");
    ...
    function mod_config(id) {
        window.location.href = "${pageContext.request.contextPath}/message/sms/config/"+id+"/mod";
    }

    function del_config(id) {
        $("#confirmcontent").html("确定要删除该短息配置吗？");
        curId = id;
    ...
    function deleteEmailConfig(){
        jQuery.get("${pageContext.request.contextPath}/message/sms/config/"+curId+"/remove",
                function(data){
                    if(data.status=="success"){
                        location.href = "${pageContext.request.contextPath}/message/sms/config/list";
                    }else{
    ...
    function deleteMultEmailConfig(){
        jQuery.ajax({
            url: '<%=request.getContextPath()%>/message/sms/config/remove',
            type: 'post',
            dataType: 'json',
            data:{ids:ids},
            async: false,
