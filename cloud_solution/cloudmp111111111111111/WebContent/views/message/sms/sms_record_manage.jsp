                        ...
                        <section class="tile color transparent-black">
                            ...
                            <div class="tile-widget color transparent-black rounded-top-corners nopadding nobg">
                                ...
                                <ul class="nav nav-tabs tabdrop">
                                    ...
                                    <li class="active"><a href="#" data-toggle="tab" onclick="redirect('/message/record/sms/list');">短信发送记录管理</a></li>
                                    <div id="space"></div>
                            ...
                            <div class="tile-header">
			                    <button type="button" class="btn btn-green file-excel-o" onclick="exportData('/export/smsrecordlistdata')">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table  class="table table-datatable table-custom table-sortable" id="basicDataTable">
                                        ...
                                        <tr>
                                            ...
                                            <th class="sortable sort-amount">发送短信服务</th>
                                        ...
                                        <tbody>
                                        <c:forEach items="${message_record_list}" var="sms_records">
                                            <tr class="gradeX">
                                                <td>
                                                    <div class="checkbox check-transparent">
                                                        <input type="checkbox" value="${sms_records.id}" name="checkboxid" id="chck${sms_records.id}" >
                                                        <label for="chck${sms_records.id}"></label>
                                                    </div>
                                                </td>
                                                <td class="cut">${sms_records.senderAddress}</td>
                                                <td class="cut">${sms_records.recipientAddress}</td>
                                                <td class="cut"><fmt:formatDate
                                                        value="${sms_records.createTimeDate}"
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu" role="menu">
                                                        <li><a href="#" onclick="show_detail('${sms_records.id }');">查看详情</a></li>
                                                        <li class="divider"></li>
                                                        <li><a href="#" onclick="del_record('${sms_records.id }');">删除</a></li>
                                                    </ul>
                                                </div>
                                                </td>
                                            </tr>
                                            ...
                                            <div class="modal-body">
                                                <form role="form">
                                                    ...
                                                    <div class="form-group">
                                                        <label style="align:center;" id="confirmcontent">确定要删除该短信发送记录吗？</label>
                                                    </div>
...
<script>
    ...
    $(function(){
        ...
        $("#recordAdd").click(function(){
            window.location.href = "${pageContext.request.contextPath}/message/sms/record/add";
        });
        ...
        jQuery("#submit_oper").click(function(){
            ...
            if(option=="delete"){
                ...
                if(myids.length < 1){
                    $("#tipscontent").html("请选择要删除的短信发送记录");
                    $("#dia").click();
                    return;
                }
                ids = myids;
                $("#confirmcontent").html("确定要删除所选短信发送记录吗？");
    ...
    function show_detail(id) {
        window.location.href = "${pageContext.request.contextPath}/message/record/sms/"+id+"/detail";
    }

    function del_record(id) {
        $("#confirmcontent").html("确定要删除该短信发送记录记录吗？");
        curId = id;
        ...
        jQuery.get("${pageContext.request.contextPath}/message/record/"+curId+"/remove",
                function(data){
                    if(data.status=="success"){
                        location.href = "${pageContext.request.contextPath}/message/record/sms/list";
                    }else{
        ...
        jQuery.ajax({
            ...
            success: function(result)
            {
                if(result.status=="success"){
                    location.href = path + "/message/record/sms/list";
                }else{
