              ...
              <div class="col-md-12">
                ...
                <section class="tile color transparent-black">
                  ...
                  <div class="tile-header">
                    <h3><a href="<%=request.getContextPath() %>/cdrpm/all"    style="color:#FAFAFA;cursor:pointer;padding-right:10px;"> <i class="fa fa-reply"></i></a>输入主机资源池信息</h3>
                    <div class="controls">
                  ...
                  <div class="tile-body">
                    ...
                    <form class="form-horizontal" role="form" parsley-validate id="basicvalidations" action="<%=request.getContextPath() %>/cdrpm/add" method="post"   >
                      <input name="prefixion" type="hidden" value="desktop_pool_"/>
					...
					<div class="form-group">
					    ...
					    <div class="col-sm-8">  
					        <div class="radio radio-transparent col-md-2">
					        	<input type="radio" name="diskType" id="optionsRadios10" value="0" onclick="$('#divNas').removeAttr('show');$('#divNas').attr('class','hidden');">
					...
					<div id="divNas" class="hidden">
						...
						<label for="path" class="col-sm-2 control-label">存储路径</label>
							<div class="col-sm-4">
							     <input type="text" class="form-control" id="path" value="${path}" placeholder="${path == null ? "还未配置共享存储,请配置后再做修改" : ""}" readonly="readonly"/>
							</div>
						</div>                      
						<%--<div class="form-group">--%>
							<%--<label for="path" class="col-sm-2 control-label">存储路径</label>--%>
